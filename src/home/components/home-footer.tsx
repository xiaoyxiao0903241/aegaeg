...
const footerLinkClass =
  'text-sm font-normal leading-[1.2] tracking-[-0.28px] max-[820px]:text-[13px] max-[820px]:leading-[1.5] max-[820px]:nth-[n+4]:hidden'
...
const footerBrandClass = cn(
  ...
  'max-[820px]:gap-[9px] max-[820px]:text-base max-[820px]:leading-[1.2] [&_img]:h-[26px]',
)
        ...
        {content.groups.map((group) => (
          ...
          >
            <Text
              as="h3"
              weight="semibold"
              className="m-0 text-sm leading-[1.2] tracking-[0.56px] text-white max-[820px]:text-[13px] max-[820px]:leading-[1.5]"
            >
              {group.label}
            </Text>
