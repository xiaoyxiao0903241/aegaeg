...
const homeArtGlowClass = cn(
  ...
  'max-tablet:left-1/2 max-tablet:-translate-x-1/2',
  'max-dapp:hidden',
)

const heroClass = {
  section:
    'hero relative flex min-h-176 items-start overflow-hidden pt-22 pb-24 [background:linear-gradient(180deg,var(--background),oklch(95.6%_0_0))] max-tablet:min-h-0 max-tablet:pt-16 max-tablet:pb-20 max-dapp:block max-dapp:min-h-192 max-dapp:pt-9 max-dapp:pb-12 max-dapp:[background:var(--background)]',
  grid:
    'container hero-grid relative z-1 grid min-h-128 grid-cols-[minmax(0,1fr)_auto] items-center justify-between gap-16 max-tablet:grid-cols-1 max-tablet:justify-items-center max-tablet:gap-8 max-tablet:text-center max-dapp:flex max-dapp:min-h-0 max-dapp:flex-col max-dapp:items-center max-dapp:justify-start max-dapp:gap-4 max-dapp:text-center',
  copy:
  ...
  title:
    'hero-title mt-5.5 max-w-168 text-6xl leading-tight max-dapp:mt-4 max-dapp:w-full max-dapp:text-4xl max-dapp:leading-tight',
  body:
  ...
  art:
    'hero-art relative w-108 max-w-full shrink-0 aspect-[438/510] max-tablet:w-full max-tablet:max-w-108 max-tablet:aspect-[438/420] max-dapp:order-1 max-dapp:w-72 max-dapp:max-w-72 max-dapp:aspect-[294/342]',
  media:
    'hero-media absolute left-2.5 top-0 w-11/12 max-w-84 aspect-[338/510] [animation:character-float_6s_ease-in-out_infinite] max-tablet:left-1/2 max-tablet:w-72 max-tablet:max-w-72 max-tablet:aspect-[278/420] max-tablet:-translate-x-1/2 max-tablet:[animation-name:character-float-centered] max-dapp:left-0 max-dapp:top-0 max-dapp:w-72 max-dapp:max-w-72 max-dapp:aspect-[294/342] max-dapp:translate-x-0 max-dapp:[animation-name:character-float-mobile]',
  video:
