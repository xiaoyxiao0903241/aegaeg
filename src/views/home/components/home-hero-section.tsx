    ...
    >
      ...
      <div className="container relative z-1 grid min-h-128 grid-cols-[minmax(0,1fr)_auto] items-center justify-between gap-16 max-tablet:grid-cols-1 max-tablet:justify-items-center max-tablet:gap-8 max-tablet:text-center max-dapp:flex max-dapp:min-h-0 max-dapp:flex-col max-dapp:items-center max-dapp:gap-4 max-dapp:text-center">
        ...
        >
          ...
          <Text
            as="h1"
            className="mt-5.5 max-w-168 text-6xl font-semibold leading-[1.08] tracking-normal max-dapp:mt-4 max-dapp:w-full max-dapp:text-4xl max-dapp:leading-[1.2]"
          ...
          <Text
            as="p"
            className="mt-5.5 max-w-168 text-lg font-normal leading-[1.5] max-dapp:mt-2.5 max-dapp:w-full max-dapp:text-sm"
            data-hero-line="body"
          ...
          >
            ...
            <Button asChild className="max-dapp:w-full max-dapp:!shadow-none" size="lg" variant="secondary">
