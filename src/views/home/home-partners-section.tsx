...
export function HomePartnersSection() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3.5 max-dapp:mt-4" data-partner-row>
        {partners.map(([name, icon]) => (
          ...
          >
            <img
              className="size-(--home-partner-icon-size) shrink-0 object-contain max-dapp:size-(--home-partner-icon-size-h5)"
              src={icon}
              alt=""
              width="24"
              height="24"
            ...
            <Text
              ...
              className="font-semibold max-dapp:text-xs"
            >
              {name}
            </Text>
          </Card>
