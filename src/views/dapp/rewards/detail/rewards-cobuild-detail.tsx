...
import { RewardsCobuildTierCard } from '~/views/dapp/rewards/detail/rewards-cobuild-tier-card'
import { rewardsRecordsPillTabsHeader } from '~/views/dapp/rewards/detail/rewards-records-pill-tabs'
import { useRewardsCobuildDetail } from '~/views/dapp/rewards/detail/use-rewards-cobuild-detail'

export function RewardsCobuildDetail() {
  const {
    cobuild,
    recordsTab,
    setRecordsTab,
