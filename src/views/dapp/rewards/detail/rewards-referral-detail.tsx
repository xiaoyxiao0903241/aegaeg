...
import { useRewardsReferralDetail } from '~/views/dapp/rewards/detail/use-rewards-referral-detail'

export function RewardsReferralDetail() {
  const {
    referral,
    totalRewards,
    myPosition,
