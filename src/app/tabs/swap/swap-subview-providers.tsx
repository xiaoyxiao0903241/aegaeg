...
import { FlashSwapWidgetProvider } from '~/app/tabs/swap/flash-swap-widget-context'
import { TradeSwapWidgetProvider } from '~/app/tabs/swap/trade-swap-widget-context'
