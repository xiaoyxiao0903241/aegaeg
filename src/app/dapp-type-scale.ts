...
/** 4175 SideTitle size=md semibold — wraps rank row-2 titles in rewards widget cards. */
export const dappSideTitleShellClass =
  'block text-base max-dapp:text-sm font-semibold leading-snug tracking-normal text-foreground'
...
export const dappRankMetaClass =
  'text-xs font-normal leading-normal tracking-[-0.24px] text-ink-strong max-dapp:text-faint'

export const dappProgressLabelClass =
  'text-xs font-normal leading-[1.5] tracking-[-0.24px] text-ink-strong max-dapp:text-faint'

export const dappProgressValueClass =
  'text-right text-xs font-semibold leading-[1.3] tracking-[-0.24px] text-foreground max-dapp:leading-[1.2]'

export const dappSideCardSpanClass = '[&_span]:text-xs [&_span]:tracking-[-0.24px]'

/** Genesis promo widget (swap footer dark card) — 4175 SideTitle/body onDark typography. */
export const dappGenesisPromoTitleClass =
  'text-sm max-dapp:text-xs font-semibold leading-normal tracking-[-0.28px] text-on-dark'

export const dappGenesisPromoBodyClass =
  'text-xs leading-normal tracking-[-0.24px] text-on-dark'
