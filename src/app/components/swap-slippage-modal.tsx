...
import { DialogOverlay, DialogPortal } from '../../components/dialog'
...
export function SwapSlippageModal({
  ...
  return (
    <DialogPrimitive.Root onOpenChange={onOpenChange} open={open}>
      <DialogPortal>
        <DialogOverlay className="bg-[oklch(0%_0_0/35%)]" />
        <DialogPrimitive.Content
          className={cn(
            'fixed left-1/2 top-1/2 z-50 w-[min(calc(100%-32px),400px)] -translate-x-1/2 -translate-y-1/2',
            'rounded-[24px] border-0 bg-card p-6 shadow-[0_30px_80px_oklch(15%_0.02_270/35%)]',
