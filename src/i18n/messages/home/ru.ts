      ...
      "items": [
        {
          ...
          "answer": "AEGIS X — первый в мире протокол экосистемы USD1, управляемый AI-аналитическим центром. USD1 — ключевой расчётный актив, связывающий AI, DeFi и глобальную платёжную сеть.",
          "open": true
        },
        {
          "question": "Как выпускается AGX?",
          "answer": "AGX создаётся через механизм 150% сверхобеспечения и является ключевым активом протокола и важным носителем роста ценности."
        },
        {
          "question": "Какую роль играет USD1 в AEGIS X?",
          "answer": "USD1 — ключевой расчётный актив протокола, обеспечивающий обращение ценности, поддержку ликвидности и платёжную инфраструктуру экосистемы."
        },
        {
          "question": "Как протокол обеспечивает безопасность?",
          "answer": "Контракты используют некастодиальные границы, аудит, открытый исходный код и мультиподписное управление."
        },
        {
          "question": "Что такое механизм Turbo?",
          "answer": "Механизм Turbo снижает риск концентрированного давления продаж через динамическое разблокирование и регулировку ликвидности, усиливая стабильность рынка и долгосрочный потенциал развития.",
          "optional": true
        },
        {
          "question": "Как работает токен X?",
          "answer": "X — токен ценности экосистемы с фиксированной эмиссией и механизмом сжигания, управляемым протоколом."
        }
      ]
    }
  },
