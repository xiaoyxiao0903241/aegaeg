  ...
  sections: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: 'Что такое механизм Turbo?',
          a: 'Механизм Turbo снижает риск концентрированного давления продаж через динамическое разблокирование и регулировку ликвидности, усиливая стабильность рынка и долгосрочный потенциал развития.'
        },
        {
