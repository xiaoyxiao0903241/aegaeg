...
const home = defineMessages({
  meta: {
    description:
      'AEGIS X — AI-native протокол DeFi 4.0 с расчетами в USD1, BSC-first кошельком и self-healing engine для новой сети ценности.',
    title: 'AEGIS X - Защита сети ценности будущего',
  },
  nav: {
  ...
  hero: {
    ...
    title: 'Защита сети ценности будущего',
  ...
  sections: {
    ...
    engine: {
      ...
      subtitle:
        'Интеллектуальные решения, динамическая регулировка и контроль рисков создают устойчивую сеть ценности.',
      cards: [
        {
        ...
        },
        {
          ...
          body: 'При дневном падении до порога комиссия продажи растет до 30%, запускаются выкуп и сжигание; через 24 ч режим нормализуется.',
        },
        {
    ...
    token: {
      ...
      subtitle:
        'Рост пользователей → усиление ликвидности → расширение платежей → рост экосистемы.',
      cards: [
        {
    ...
    roadmap: {
      ...
      phases: [
        ...
        },
        {
          ...
          description:
            'Автономные платежи · интеллектуальное взаимодействие · экономическая сеть AI Agent',
          dot: '4',
          side: 'right',
        },
        {
          ...
          title: 'Глобальные платежи',
          description:
            'Глобальная платёжная сеть · подключение мерчантов · платёжные сценарии USD1',
          dot: '5',
          side: 'left',
        },
        {
