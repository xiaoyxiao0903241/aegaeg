...
const home = defineMessages({
  meta: {
    description:
      'AEGIS X एक AI-नेटिव DeFi 4.0 प्रोटोकॉल है, USD1 निपटान, BSC-प्राथमिकता वॉलेट प्रवेश और स्व-सुधार प्रोटोकॉल इंजन के साथ अगली पीढ़ी का मूल्य नेटवर्क बनाता है।',
    title: 'AEGIS X - भविष्य के मूल्य नेटवर्क की रक्षा',
  },
  nav: {
  ...
  hero: {
    ...
    title: 'भविष्य के मूल्य नेटवर्क की रक्षा',
  ...
  sections: {
    ...
    engine: {
      ...
      subtitle:
        'बुद्धिमान निर्णय, गतिशील समायोजन और जोखिम नियंत्रण के माध्यम से, स्थायी मूल्य नेटवर्क का निर्माण।',
      cards: [
        {
          title: 'स्मार्ट मार्केट मेकिंग तंत्र',
          body: 'तेज़ी के चरण में रिज़र्व संपत्ति संचय, प्रोटोकॉल रिज़र्व क्षमता बढ़ाना; सुधार चरण में रीबाय और बर्न तंत्र, मूल्य सुधार।',
        },
        {
    ...
    security: {
      ...
      subtitle: 'प्रोटोकॉल वास्तुकला से संपत्ति प्रबंधन तक, हर चरण में सुरक्षा',
      checks: [
