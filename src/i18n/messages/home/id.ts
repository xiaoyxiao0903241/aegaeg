...
const home = defineMessages({
  meta: {
    description:
      'AEGIS X adalah protokol DeFi 4.0 AI-native dengan settlement USD1, wallet BSC-first, dan engine self-healing untuk jaringan nilai baru.',
  ...
  sections: {
    ...
    engine: {
      ...
      subtitle:
        'Melalui keputusan cerdas, penyesuaian dinamis, dan kontrol risiko, membangun jaringan nilai yang berkelanjutan.',
      cards: [
        {
    ...
    token: {
      ...
      subtitle:
        'Pertumbuhan pengguna → peningkatan likuiditas → ekspansi pembayaran → pertumbuhan ekosistem.',
      cards: [
        {
    ...
    security: {
      ...
      subtitle:
        'Dari arsitektur protokol hingga manajemen aset, keamanan menyeluruh di setiap tahap',
      checks: [
