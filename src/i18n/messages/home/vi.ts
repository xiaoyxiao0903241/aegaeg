...
const home = defineMessages({
  meta: {
    description:
      'AEGIS X là giao thức DeFi 4.0 bản địa AI với thanh toán USD1, truy cập ví ưu tiên BSC và công cụ giao thức tự phục hồi, xây dựng mạng lưới giá trị thế hệ tiếp theo.',
  ...
  sections: {
    ...
    engine: {
      ...
      subtitle:
        'Thông qua ra quyết định thông minh, điều chỉnh động và kiểm soát rủi ro, xây dựng mạng lưới giá trị bền vững.',
      cards: [
        {
    ...
    token: {
      ...
      subtitle:
        'Tăng trưởng người dùng → Tăng cường thanh khoản → Mở rộng thanh toán → Tăng trưởng hệ sinh thái.',
      cards: [
        {
    ...
    roadmap: {
      ...
      phases: [
        ...
        },
        {
          ...
          title: 'Thanh toán toàn cầu',
          description:
            'Mạng lưới thanh toán toàn cầu · Tích hợp thương gia · Kịch bản thanh toán USD1',
          dot: '5',
          side: 'left',
        },
        {
