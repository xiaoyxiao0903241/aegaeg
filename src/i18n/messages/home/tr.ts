...
const home = defineMessages({
  meta: {
    description:
      'AEGIS X, AI-native DeFi 4.0 protokolüdür; USD1 uzlaşması, BSC öncelikli cüzdan girişi ve kendi kendini onaran protokol motoruyla geleceğin değer ağını inşa eder.',
  ...
  sections: {
    ...
    engine: {
      ...
      subtitle:
        'Akıllı karar verme, dinamik ayarlama ve risk kontrolüyle sürdürülebilir bir değer ağı oluşturur.',
      cards: [
        {
