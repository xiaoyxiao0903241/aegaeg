...
const app = defineMessages({
    ...
    genesis: {
        ...
        intro: 'Participa en el plan de co-construcción X DAO · Fase {season}  ({discount} de descuento)',
        ...
        xTokenAirdropHint: 'La participación acumulada en co-construcción por fase ≥ {threshold} da derecho a recompensas de airdrop.',
        ...
        purchaseUnavailable: 'No puedes participar en la suscripción en este momento. Revisa las participaciones o el estado de la fase.',
