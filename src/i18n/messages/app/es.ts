...
const app = defineMessages({
  ...
  nav: {
    ...
    proposalTooltip: 'Participa en las propuestas y votaciones del protocolo.',
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: 'Tras conectar, tus votos de propuestas aparecerán aquí.',
  ...
  staking: {
    ...
    calc: {
      ...
      priceXAria: 'Entrada de precio X',
