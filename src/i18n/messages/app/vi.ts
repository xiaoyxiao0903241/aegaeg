...
const app = defineMessages({
    ...
    rewards: {
        ...
        superCommunityBenefitBody: 'Siêu cộng đồng nhận quỹ phát triển chuyên dụng và quyền quản trị.',
        ...
        communityFundTooltip: 'Siêu cộng đồng nhận 5% quỹ phát triển hệ thống, dành riêng cho vận hành tự chủ, bao gồm nhưng không giới hạn: xây dựng hệ thống, vận hành hàng ngày, họp hệ thống và giảng viên hệ thống.',
