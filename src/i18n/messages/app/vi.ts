...
const app = defineMessages({
  ...
  rewards: {
    ...
    hub: {
      ...
      mechanismFooter:
        'Cơ chế hai nhánh bất kỳ: hai nhánh đạt hạng tương ứng là thăng hạng. Hạng càng cao tỷ lệ thưởng càng cao; tối đa thưởng thành tựu trọn đời và cổ tức toàn cầu.',
      aboutSlides: {
        lucky: {
  ...
  assets: {
    ...
    position: {
      ...
      activateWarmup: 'Kích hoạt warmup',
      activateWarmupSuccess: 'Warmup đã kích hoạt',
