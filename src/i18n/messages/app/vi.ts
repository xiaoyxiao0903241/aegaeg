...
const app = defineMessages({
    ...
    swap: {
      ...
      hub: {
            ...
            flash: {
              ...
              openProvider: 'Xem hợp đồng flash swap trên BscScan',
    ...
    genesis: {
      ...
      xTokenAirdropHint: 'Phần thưởng airdrop yêu cầu tổng tham gia đồng xây theo mùa ≥ {threshold}.',
      ...
      totalContributed: 'Đồng xây mùa này',
