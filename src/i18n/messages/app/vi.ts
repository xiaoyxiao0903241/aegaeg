...
const app = defineMessages({
  ...
  nav: {
    ...
    proposalTooltip: 'Tham gia đề xuất và bỏ phiếu của giao thức.',
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: 'Sau khi kết nối, phiếu đề xuất của bạn sẽ hiển thị tại đây.',
        ...
        items: [
          {
            ...
            a: 'Nhận lợi nhuận từ staking, trái phiếu và nguồn khác tiêu điểm đóng góp theo 1:1 (nhận 1 gAGX tiêu 1 điểm). Không đủ điểm thì không nhận được.',
          },
          {
            q: 'Vì sao nhận lợi nhuận phải tiêu điểm đóng góp?',
            a: 'Cơ chế gắn nhận thưởng với giảm phát giao thức: mỗi lần nhận 1 gAGX tiêu 1 điểm đóng góp; điểm chỉ có từ đốt AGX. Mỗi lần rút lợi nhuận đều tương ứng lượng AGX bị đốt bằng nhau, liên tục chống đỡ giảm phát AGX.',
          },
          {
            q: 'Tỷ lệ đốt là bao nhiêu?',
            a: 'Đốt theo tỷ lệ 1:6: mỗi 1 AGX đốt nhận 6 điểm đóng góp. AGX đã đốt vào thẳng địa chỉ hố đen và rời lưu thông vĩnh viễn.',
          },
          {
            q: 'AGX đã đốt đi đâu?',
      ...
      faq: {
        items: [
          ...
          },
          {
            ...
            a: 'Mở khóa là dùng USD1 mua cùng số AGX, mở khóa gAGX và bắt đầu chờ; rút là sau 24–96 giờ chờ, chuyển gAGX đã mở khóa về ví. Hai bước hiện trong bản ghi Turbine là 「Mở khóa」 và 「Rút」.',
          },
          {
            q: 'Thời gian chờ bao lâu?',
            a: 'Mỗi lần mở khóa vào thời gian chờ 24–96 giờ; thời lượng cụ thể hệ thống tự điều chỉnh theo thị trường. Hết chờ thì rút được khoản gAGX đó.',
          },
          {
      ...
      items: [
        {
          ...
          a: 'Người dùng dùng USD1 tham gia cùng xây dựng, có thể nhận AGX theo mức giảm giá tương ứng từng giai đoạn. 3 giai đoạn, mức giảm giá lần lượt 30%, 25%, 20%.',
        },
        {
          q: 'Hạn mức cùng xây dựng và yêu cầu tham gia?',
          a: 'Tối thiểu $100, tham gia theo bội số 100 USD1. Hạn mức từng giai đoạn: $100 – $10,000, $100 – $10,000, $100 – $30,000.',
        },
        {
        ...
        },
        {
          ...
          a: 'Tài khoản tích lũy tham gia cùng xây dựng đạt $1,000 sẽ đủ điều kiện nhận phần thưởng airdrop X tương ứng giai đoạn. Tỷ lệ airdrop 3 giai đoạn: 5%, 2%, 1%.',
        },
        {
  ...
  rewards: {
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Ở bảng nhận bên trái chọn tỷ lệ nhận và tái stake: phần nhận vào hồ giải phóng giải phóng tuyến tính theo chu kỳ đã chọn; phần tái stake vào staking đơn token lãi kép. Cả hai tiêu 1:1.',
          },
          {
    ...
    cobuild: {
      ...
      tierLifetime: 'Lifetime achievement',
      tierNoLevel: 'No tier yet',
      tierNoLevelHint: 'Meet A1 requirements to start earning co-build rewards',
      tierProgressReach: 'Progress to reach {level}',
      reqDualLines: 'Dual lines at {level}',
      reqDualLinesHint: 'Path 1: any two lines reach {level}',
      reqDualLinesValue: '{count} lines',
      reqDualLinesTarget: '2 lines',
      reqOtherLine: 'Other-line performance',
      reqOtherLineHint: 'Path 2: one line at {level} and other-line performance meets the target',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Ở đầu bảng nhận bên trái chuyển Cùng xây dựng / San bằng, rồi chọn tỷ lệ. Cùng cơ chế giải phóng/tái stake và tiêu 1:1.',
          },
          {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Nhận thưởng tiêu 1:1 (nhận 1 gAGX tiêu 1 điểm). Thiếu điểm thì lấy trên trang Đốt.',
        },
        {
        ...
        },
        {
          ...
          a: 'Thưởng may mắn tất toán mỗi ngày 00:00 UTC. Các thưởng khác theo Rebase, khoảng mỗi 12 giờ. Lần tiếp theo xem trên bảng dữ liệu từng trang chi tiết.',
        },
        {
  ...
  community: {
    ...
    cobuildLevel: 'Cấp cùng xây dựng',
    makingLevel: 'Cấp cùng xây dựng',
    ...
    myInvites: 'Thành viên giới thiệu trực tiếp của tôi ({count})',
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: 'Thưởng giới thiệu Genesis tính thế nào?',
          a: 'Thưởng giới thiệu Genesis là 3%, dùng quyết toán nén số tiền tương đương, chỉ tính phần số tiền bằng nhau.',
        },
        {
          q: 'Làm sao nâng cấp Genesis?',
          a: 'Theo số tiền cùng xây dựng cá nhân và thành tích hệ thống, thăng từ S1 đến S10.',
        },
        {
  ...
  proposal: {
    title: 'Proposals',
    intro: 'Take part in protocol proposals and voting.',
    disconnectedIntro: 'Connect your wallet to lock AGX and vote.',
    backToList: 'Back to proposals',
    voted: 'Voted',
    for: 'For',
    against: 'Against',
    amountAria: 'AGX to lock for this vote',
    lockToVote: 'Lock AGX to vote',
    available: 'Available {amount}',
    votePowerHint:
      'Voting power is 1:1 with locked AGX. You can vote more than once on the same proposal; power adds up. Unlock after voting ends. Proposal rewards follow rebase in AGX, paid straight to your wallet — no contribution points and no turbine.',
    voteSuccess: 'Vote submitted',
    withdrawSuccess: 'Withdrawal submitted',
    voteDeadline: 'Vote ends {time}',
    voteOpens: 'Voting opens {time}',
    voteEnded: 'Voting ended {time}',
    voteMeta: '{time} · {amount} participating',
    ...
    closed: {
      pending: 'The proposal has not opened for voting yet. You can lock AGX once it starts.',
    ...
    blocked: {
      ...
      belowMin: 'Minimum vote is 1 AGX',
      notBound: 'Bind a referrer before voting.',
      notActive: 'This proposal is not open for voting.',
      supportMismatch: 'You can only add to the same stance on this proposal.',
      votesLimited: 'This vote would exceed the proposal vote cap.',
      insufficientBalance: 'Insufficient AGX balance',
      insufficientAllowance: 'Approve AGX before voting.',
      unavailable: 'Voting is temporarily unavailable.',
      notWithdrawable: 'Withdrawal is not open yet.',
      expired: 'The 10-day withdrawal window has ended.',
      nothingToWithdraw: 'Nothing left to withdraw.',
    },
    statsTitle: 'Overview',
    statTotal: 'Total proposals',
    statTotalNote: '{active} active · {pending} upcoming',
    statLocked: 'Locked for votes',
    statLockedNote: 'Available to vote {amount}',
    statParticipation: 'Average participation',
    statParticipationNote: 'Last 10 proposals',
    votesTitle: 'My votes',
    listEmpty: 'Official proposals will appear here when published.',
    ...
    mechanism: {
      items: [
        {
          title: 'Lock to vote',
          body: 'Lock AGX when you vote. Voting power is 1:1 with the locked amount. Locked AGX can be unlocked directly after that proposal’s voting period ends, with no cooldown.',
        },
        {
          title: 'Proposal rewards',
          body: 'When the proposal settles, proposal rewards are paid in AGX with rebase yield, claimable straight to your wallet — no contribution points and no turbine. Anyone who voted receives them, regardless of the outcome.',
        },
        {
          title: 'Pass and execute',
          body: 'When voting ends, more voting power for than against means it passes; passed proposals enter execution, and the multisig contract completes on-chain execution within 48 hours.',
        },
      ],
    },
    eligibility: {
      title: 'Who can create proposals',
      body: 'At this stage proposals are created by the official team; the community votes on whether they pass. Before publication, an announcement explains the background and impact. Community members can submit suggestions through official channels; after review the team may draft them into a formal proposal for a vote. As the protocol gradually decentralizes, community proposal rights will open through a proposal vote.',
    },
    faq: {
      title: 'FAQs',
      items: [
        {
          ...
          a: 'Voting power is 1:1 with the AGX you lock on that proposal. Locking 100 AGX gives 100 votes of voting power. You choose how much to lock when you vote, and it can be less than your wallet balance.',
        },
        {
        ...
        },
        {
          ...
          a: 'Proposal rewards are paid in AGX with rebase yield based on your voting power on that proposal. You receive them whether the proposal ultimately passes or fails, and whether you voted for or against.',
        },
        {
        ...
        },
        {
          ...
          a: 'At this stage proposals are created by the official team and community members vote. You can submit suggestions through official channels; after review the team may draft them into a formal proposal for a community vote.',
        },
        {
          q: 'How does a proposal pass?',
          a: 'When voting ends, if voting power for is greater than voting power against, the proposal passes and then enters execution.',
        },
        {
  ...
  assets: {
    ...
    blocked: {
      ...
      insufficientContribution: 'Điểm đóng góp không đủ, hãy đổi điểm đóng góp trước',
    ...
    claim: {
      ...
      taxRate: 'thuế {rate}%',
      contribNeed: 'Lần nhận này trừ điểm đóng góp {amount}',
      contribShort: 'Điểm đóng góp không đủ, hãy đốt để đổi điểm đóng góp',
      goBurn: 'Đi đốt để đổi',
      ctaMixed: 'Tái stake & nhận',
      ctaRelease: 'Nhận',
    ...
    claimOutput: {
      ...
      contribDeduct: 'Khấu trừ điểm đóng góp {amount}',
    },
    redeem: {
    ...
    hub: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: 'Làm sao nhận điểm đóng góp?',
            a: 'Mua và đốt AGX. Nhận tiêu 1:1 (nhận 1 gAGX tiêu 1 điểm đóng góp); hãy chuẩn bị đủ.',
          },
          {
            q: 'Vì sao nhận lợi nhuận phải chọn chu kỳ giải phóng?',
            a: 'Không về ngay; giải phóng tuyến tính; chu kỳ càng dài thuế càng thấp: 5 ngày 20%, 20 ngày 10%, 40 ngày 5%, 60 ngày 1%.',
          },
          {
          ...
          },
          {
            ...
            a: 'Tái stake bỏ qua giải phóng, thuế tốt hơn (360 ngày 15%, 540 ngày 10%), lãi kép trong staking đơn token. Nhận linh hoạt hơn.',
          },
          {
            q: 'Hồ đệm là gì?',
            a: 'Sau gỡ stake, gốc vào bộ đệm giải phóng tuyến tính lần hai 30 ngày. Phần 「đã giải phóng」 trong bộ đệm chuộc về ví bất cứ lúc nào.',
          },
        ],
      },
    },
          ...
          items: [
            {
              ...
              a: 'Nhận cho lợi nhuận (chu kỳ giải phóng hoặc tái stake). Chuộc cho gốc AGX đã giải phóng → bộ đệm 30 ngày rồi về ví.',
            },
            {
  ...
  staking: {
    ...
    blocked: {
      ...
      insufficientQuotaWithAmount:
        'Đã vượt hạn mức stake: hiện còn có thể stake tối đa {quota}. Hãy giảm số lượng rồi thử lại.',
      insufficientQuotaPersonalWithAmount:
        'Đã vượt hạn mức stake cá nhân của bạn: hạn mức tích lũy cá nhân còn {quota}, hãy giảm số lượng rồi thử lại.',
      insufficientQuotaPersonalDailyWithAmount:
        'Đã vượt hạn mức stake hôm nay của bạn: hạn mức cá nhân hôm nay còn {quota}, hãy giảm số lượng, hoặc đợi hạn mức làm mới rồi thử lại.',
      insufficientQuotaPoolWithAmount:
        'Hạn mức hồ stake trên chuỗi không đủ: hồ hiện còn {quota}, hãy giảm số lượng, hoặc thử lại sau.',
      insufficientXmineQuotaWithAmount:
        'Đã vượt hạn mức mining của bạn: hạn mức mining do vốn gốc khóa quyết định, hiện còn có thể stake tối đa {quota}. Hãy giảm số lượng, hoặc tăng vị thế khóa trước rồi thử lại.',
    ...
    stake: {
      ...
      amountBalance: 'Số lượng (số dư ví {balance})',
      quotaInline: 'Hạn mức stake: {quota}',
      submit: 'Đặt cọc',
    ...
    xmine: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'gAGX đã mở khóa giải phóng tuyến tính theo khối 30 ngày.',
        },
        {
  ...
  release: {
    ...
    faq: {
      ...
      buffer: [
        {
          q: 'Hồ đệm là gì?',
          a: 'Sau chuộc, giải phóng tuyến tính lần hai 30 ngày. Làm mượt dòng ra.',
        },
        {
