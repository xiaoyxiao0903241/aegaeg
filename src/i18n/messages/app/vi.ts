...
const app = defineMessages({
    ...
    swap: {
        ...
        transactionCancelled: 'Giao dịch đã bị hủy trong ví',
        overview: 'Tổng quan',
        ...
        hub: {
            modes: {
                flash: {
                    title: 'Chuyển đổi',
                    body: 'Chuyển USDT sang USD1, không phí, không trượt giá',
                },
                trade: {
                    title: 'Giao dịch',
        ...
        flash: {
            title: 'Chuyển đổi',
            intro: 'Chuyển USDT sang USD1, không phí, không trượt giá',
            providerName: 'AEGIS X',
            openProvider: 'Xem hợp đồng chuyển đổi trên BscScan',
    ...
    genesis: {
        ...
        xTokenAirdropHint: 'Phần thưởng airdrop yêu cầu tổng tham gia cùng xây dựng theo giai đoạn ≥ {threshold}.',
        ...
        purchaseUnavailable: 'Hiện không thể tham gia đăng ký. Vui lòng kiểm tra số phần hoặc trạng thái giai đoạn đăng ký.',
