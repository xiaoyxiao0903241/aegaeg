...
const app = defineMessages({
  ...
  onboarding: {
    ...
    steps: [
      ...
      {
        title: '単一資産ステーキング',
        body: '「ステーキング」カードで AGX をステーキング。1日 2 回の Rebase で複利成長し、期間が長いほど収益率ボーナスが高くなります。',
      },
      {
        title: '資産',
  ...
  exchange: {
    ...
    hub: {
      ...
      faq: {
        items: [
          {
            q: '交換ページでは何ができますか？',
            a: 'フラッシュで USDT→USD1、gAGX→AGX に交換し、PancakeSwap で AEGIS X エコシステムトークンを取引し、AGX をバーンして貢献ポイントを獲得し、USD1 でタービン内のアンロック gAGX を購入できます。',
          },
          {
            q: 'フラッシュと取引の違いは？',
            a: 'フラッシュはプロトコル固定ルートでユーザースリッページ設定なし。取引は PancakeSwap のリアルタイムレートに基づき、カスタムスリッページ設定が可能で、価格影響が発生する場合があります。',
          },
          {
    ...
    flash: {
      ...
      faq: {
        items: [
          {
            q: 'gAGX とは？',
            a: 'gAGX は Rebase と DAO リワードの統一決済バウチャーです。AGX ステーキングや債券の Rebase 収益、各種 DAO リワードはすべて gAGX で支給されます。',
          },
          {
            q: 'gAGX と AGX の交換比率は？',
          ...
          {
            q: 'gAGX はどう取得しますか？',
            a: 'プロトコルの収益分配に参加すると、対応数量の gAGX を受け取ります。',
          },
          {
            q: 'gAGX は AGX への交換以外に何ができますか？',
            a: 'いつでも 1:1 で AGX に交換してステーキング複利を続けたり、ステーキングして X を採掘しエコシステム配当を得たりできます。どちらも自由に選べます。',
          },
          {
            q: 'USDT を USD1 にどう交換しますか？',
            a: 'フラッシュ上部で「USDT → USD1」ペアに切り替え、数量を入力するとプロトコルレートで交換でき、オンチェーン即時着金します。',
          },
          {
            q: 'USD1 を USDT に戻せますか？',
            a: 'フラッシュ経路は一方向の USDT→USD1 です。他資産へ戻す場合は取引ページの市場交換を使ってください。',
          },
          {
            q: 'フラッシュ履歴はどこで確認できますか？',
            a: 'フラッシュはオンチェーンで成立し、数秒で着金します。各取引はウォレットまたはブロックエクスプローラーで確認できます。',
          },
        ],
      },
    },
    ...
    burn: {
      ...
      history: {
        ...
        consumeColumns: ['時間', '消費貢献ポイント', 'トランザクションハッシュ'],
      },
      faq: {
        items: [
          {
            q: '貢献ポイントの用途は？',
            a: '混合収益の受取や再投資などの流れでは貢献ポイントが必要です。残高不足だと受取は失敗するため、先に AGX をバーンして補充してください。',
          },
          {
            q: '収益受取に貢献ポイントが必要な理由は？',
            a: 'プロトコルは貢献ポイントで受取・再投資の資格を制約します。消費量はリワード金額に関連するため、先にアカウントの貢献値を十分にしてください。',
          },
          {
            q: 'バーン比率はいくらですか？',
            a: 'バーン比率はオンチェーンの rateBps で設定されます。貢献ポイント = バーン AGX × rateBps ÷ 10000。',
          },
          {
          ...
          {
            q: '貢献ポイントは譲渡や返金できますか？',
            a: '貢献ポイントは AgxContributionSwap 契約のアカウント台帳に記録され、譲渡できず、AGX への返金もできません。',
          },
        ],
      },
    },
    turbine: {
      ...
      faq: {
        items: [
          ...
          {
            q: 'アンロックに買いが必要な理由は？',
            a: 'アンロックには、現在価格で同量の AGX を USD1 で買う必要があります（数量 1:1）。支払う USD1 額は AGX 相場に連動し、USD1 と AGX の価格が固定 1:1 ではありません。',
          },
          {
            q: 'アンロックと引出の違いは？',
            a: 'アンロック：USD1 を支払って AGX を買い、クールダウンを開始。引出：クールダウン満了後に gAGX をウォレットへ受取。',
          },
          {
            q: 'クールダウン時間はどのくらいですか？',
          ...
          },
          {
            ...
            a: '購入した AGX はウォレットへ入ります。クールダウン満了後、gAGX を別途引出します。',
          },
        ],
      },
    },
  ...
  rewards: {
    ...
    hub: {
      ...
      mechanismFooter:
        '任意の 2 ラインが対応ランクに達すると昇格できます。ランクが高いほどボーナス比率が高く、最高で生涯達成賞とグローバル配当を得られます。',
      aboutSlides: {
        lucky: {
          title: 'ラッキー賞',
          body: 'ブロック幸運抽選。当選した共創者にランダム配布。当選後は Mixed で受取。',
        },
        referral: {
          title: '紹介賞',
        ...
        cobuild: {
          title: '共創賞',
          body: 'チーム協業と長期共創による持続可能インセンティブ。ランク比率で分配。Mixed 受取には貢献ポイントが必要。',
        },
        grant: {
          title: '発展手当',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'はい。流動ステーキング（liquidStake）は、1回の金額がしきい値に達した場合、当日資格に計上されます。資格は1回ごとに判定され、複数回の合算ではありません。当日の流動上限により1回でしきい値に達できない場合、その回は資格を得られません。',
          },
        ],
      },
    },
    ...
    genesisDetail: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: '創世ランクはどう昇格しますか？',
            a: '個人共創金額と体系業績の達成に応じて、S1 から S10 まで段階的に昇格します。',
          },
          {
            q: 'ランク昇格リワードとは？',
            a: 'ランクリワードは現在の創世ランクに対応する比率でチーム共創金額を決済し、受取可能枠は RewardClaimer 署名でウォレットへ受取ります。',
          },
          {
            q: '創世チームリワードはどう決済されますか？',
            a: '直紹介リワードはウォレットへ自動決済。ランクリワードと発展基金はそれぞれ RewardClaimer / CommunityFund 署名で受取ります。',
          },
        ],
      },
    },
    ...
    faq: {
      ...
      items: [
        {
          q: 'リワードはどの形態で支給されますか？',
          a: '大半のリワードは AGX / gAGX 口径で表示。創世共創リワードは RewardClaimer 資産で支給。Mixed 受取時、リリース分はリリースプールへ入ります。',
        },
        {
          q: 'リワード受取に必要な条件は？',
          a: '単純署名リワードは受取可能残高と有効な署名が必要。Lucky / DaoPool Mixed は十分な貢献ポイントと、リリース・再投資比率の選択も必要です。',
        },
        {
          q: '受取したリワードはいつ着金しますか？',
          a: 'オンチェーントランザクション確認後に着金。リリース分は選択期間で線形リリース、再投資分は対応する再投資ポジションへ入ります。',
        },
        {
          q: 'リワードはいつ決済されますか？',
          a: '各リワード源は契約とバックエンド走査ルールで決済。フロントは受取可能残高と署名ペイロードを正とします。',
        },
        {
          q: '一部のリワードカードが表示されない理由は？',
          a: '未接続または未署名ログイン時はログイン案内を表示し、リワードなしとは異なります。ログイン後も — の場合は、受取可能がないかデータ未準備です。',
        },
      ],
    },
  ...
  assets: {
    ...
    position: {
      ...
      activateWarmup: 'ウォームアップを有効化',
      activateWarmupSuccess: 'ウォームアップ有効化済み',
    ...
    hub: {
      ...
      modes: {
        stake: {
          ...
          aprHint: '収益には Rebase ボーナスと複利を含み、ポジション内の未引出収益のみ集計',
        },
        lpbond: {
          title: 'LP債券',
          body: '流動性債券ポジションを管理',
          aprHint: '収益には複利を含み、ポジション内の未引出収益のみ集計',
        },
        burnbond: {
          title: 'バーン債券',
          body: 'バーン債券ポジションを管理',
      ...
      overview: {
        ...
        totalValue: '総資産価値',
        totalValueHint:
          '現在市場価格で評価 · 保有元本と未引出収益を含む。横断製品の見積がない場合は — を表示',
        claimable: '受取可能収益',
        claimed: '累計受取済み',
        contribution: '貢献ポイント',
      ...
      rebase: {
        ...
        steps: [
          ...
          { title: 'Epoch', body: '約 14,400 ブロック\\n約 12 時間' },
      ...
      faq: {
        ...
        items: [
          {
            q: '総資産価値はどう計算されますか？',
            a: '各製品ポジションの元本と未引出収益の評価を合計。横断製品の見積がない場合は —。ウォレットの遊休残高は含めません。',
          },
          {
            q: '収益はどの形態で支給されますか？',
            a: 'ステーキングと債券の Rebase 収益は gAGX で計量。Xマイニング産出は X。',
          },
          {
            q: '収益を受取れない理由は？',
            a: 'Mixed 受取は貢献値を消費します。不足時は先に AGX をバーンして貢献値を得てから受取してください。',
          },
          {
            q: '貢献値はどう得ますか？',
          ...
          },
          {
            ...
            a: '受取した収益はリリースプールに入り、選択期間で線形リリースされます。期間が長いほど税率は通常低くなります。',
          },
          {
            q: '収益受取後はどこへ行きますか？',
            a: 'ウォレットへ即時着金せず、RewardQueue / リリースプールで期間リリース。リリース済み分はリリースページで受取できます。',
          },
          {
            q: '収益の再投資と受取の違いは？',
            a: '再投資は収益を再投資ポジションへ直接入れて利息継続。受取はリリース期間に沿って段階着金で、より柔軟です。',
          },
          {
            q: 'バッファプールとは？',
      ...
      stake: {
        ...
        faq: {
          ...
          items: [
            {
              q: '受取と償還の違いは？',
              a: '受取は収益を処理（再投資へ分流可）。償還は元本をリリースバッファへ送ります。',
            },
            {
              q: 'なぜ各ステーキングが個別表示されますか？',
              a: '各建玉は独立して利息とリリース進捗を計算し、ポジション単位で受取・償還しやすくします。',
            },
            {
              q: '「リリース済み」とは？',
              a: '定期ポジション満期後に償還できる元本部分。',
            },
            {
              q: 'カウントダウン終了後はどうなりますか？',
              a: '残り時間がゼロになると、対応ポジションは償還/操作可能になります。オンチェーン状態を正としてください。',
            },
            {
              q: '受取時の再投資比率はどう使いますか？',
              a: 'スライダーでリリースと再投資の比率を分け、リリース期間と再投資期間を選んで確認します。',
            },
          ],
        },
      },
  ...
  staking: {
    ...
    hub: {
      modes: {
        stake: {
          title: 'ステーキング',
          body: 'AGX をステーキング — 1日 2 回の Rebase 複利成長',
        },
        lpbond: {
          title: 'LP債券',
      ...
      overview: {
        ...
        metrics: [
          ...
          },
          {
            id: 'rebase',
            label: '現在の Rebase 収益率',
            hint: '各 Epoch（約 12 時間）に1回決済し、プロトコル運行状態に応じて動的調整',
          },
          {
            id: 'runway',
            label: '運行可能期間',
    ...
    stake: {
      title: 'ステーキング',
      intro: 'AGX をステーキング · 1日 2 回の Rebase 複利成長',
      ...
      mechanismSteps: [
        ...
        {
          title: '毎日の Rebase 収益',
          body: '各 Epoch（約 12 時間）で自動決済し、収益は gAGX として複利蓄積。',
        },
        {
          title: '満期リリースと受取',
    ...
    xmine: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'アンロック後の gAGX は約 30 日のブロック線形リリースで、集中売圧リスクを下げ、長期価値捕捉力を高めます。',
        },
        {
          q: 'X の総量は？増発しますか？',
          a: 'X 総発行量は 2.1 億枚固定で、追加発行なし。うち 47.62% は LP 流動性構築、52.38% はグローバルリワードと発展向け。',
        },
        {
          q: 'gAGX はどう取得しますか？',
          a: 'gAGX は Rebase と DAO リワードの統一決済バウチャーです。AGX ステーキングや債券の Rebase 収益、各種 DAO リワードはすべて gAGX で支給されます。',
        },
        {
          ...
          a: 'gAGX はいつでも 1:1 で AGX に交換してステーキング複利を続けたり、ステーキングして X を採掘しエコシステム配当を得たりできます。',
        },
        {
          q: 'X が継続デフレになる理由は？',
          a: 'X は売却のたびに 25% が自動バーン。エコシステム成長が需要と流通を押し上げ、バーンが蓄積して長期デフレ循環を形成します。',
        },
        {
          q: 'X の価値源は？',
          a: '三重の需要が重なります。gAGX ステーキングマイニングによる X 需要、プラットフォーム収益の還流、アプリ拡大とユーザー増が X 需要を強化します。',
        },
        {
          q: '上限が債券/長期ステーキング保有と連動する理由は？',
          a: 'X マイニング参加者をプロトコルの長期建設者に揃える仕組みです。債券または長期ステーキング保有を増やすと上限が上がります。契約は miningQuotaOf で枠を返します。',
        },
      ],
    },
    calc: {
  ...
  release: {
    ...
    hub: {
      ...
      mechanismSteps: [
        ...
        { title: '6 : 1 貢献メカニズム', body: '50% バーン · 50% を X 底プールへ注入' },
    ...
    faq: {
      ...
      hub: [
        {
          q: 'リリース期間は変更できますか？',
          a: '入キュー時に選んだ期間は変更不可。新しい受取では別期間を選べます。',
        },
        {
          q: '税率はいつ控除されますか？',
          a: '選択したリリース計画の料率で、リリース済み分の受取時に控除されます。',
        },
        {
          q: 'リリースプールから受取した gAGX はどこへ行きますか？',
          a: 'オンチェーンでは AGX としてタービン売却枠へ入り、その後タービン手順で gAGX に換えます。',
        },
        {
          q: 'リリース済み分をすぐ受取しないと損失がありますか？',
          a: 'アンロック済み分はいつでも受取でき、遅延しても減衰しません。',
        },
        {
          q: '適切なリリース期間はどう選びますか？',
          a: '期間が長いほど税率が低い。流動性ニーズに応じて 5 / 20 / 40 / 60 日から選択。',
        },
      ],
      queue: [
        {
        ...
        {
          q: 'リリースプールから受取した gAGX はどこへ行きますか？',
          a: 'タービン枠へ入ります。交換レールのタービンへ進んでください。',
        },
        {
          q: 'リリース済み分をすぐ受取しないと損失がありますか？',
          a: '遅延しても減衰しません。',
      ...
      buffer: [
        ...
        },
        {
          ...
          a: 'バッファ期間中はステーキング収益は発生しません。',
        },
        {
          q: 'リリース済み分はどう引き出しますか？',
          a: '引出をタップすると、AGX がウォレットへ直接入ります。',
        },
        {
          q: 'バッファプールに AGX と gAGX の両方がある理由は？',
          a: '画面では両カードを残します。オンチェーンのバッファプールは AGX のみ決済し、gAGX 退出は既に換算済みです。',
        },
        {
          q: 'リリース済み資産を一度に全部引き出せない理由は？',
          a: '現在アンロック済みの枠のみ引出可能。未満期分は引き続き待機が必要。',
        },
      ],
    },
  },
