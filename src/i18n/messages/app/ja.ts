...
const app = defineMessages({
  ...
  swap: {
    ...
    connectExploreTitle: '接続後にAEGIS Xの機能を探索',
    connectExploreAction: '接続後に利用できる機能 →',
    overview: '概要',
    exchangeRate: '交換レート',
    fixedRate: '1 : 1 固定',
  ...
  genesis: {
    ...
    connectBrandLine: '未来の価値ネットワークを守る',
    contributionsConnectTitle: 'ウォレットを接続して記録を表示',
    contributionsConnectBody: '接続後、共創履歴がここに表示されます。',
    ...
    promoTitle: 'Genesis Season 1 · 30%割引',
    promoBody: '開催中、枠限定、07.10終了',
  ...
  rewards: {
    ...
    allTiers: '創世栄誉体系',
    history: 'リワード記録',
    historyConnectBody: '接続後、リワード履歴がここに表示されます。',
