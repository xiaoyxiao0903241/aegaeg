...
const app = defineMessages({
  ...
  nav: {
    ...
    proposalTooltip: 'プロトコル提案への投票に参加します。',
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: '接続後、提案の投票記録がここに表示されます。',
    ...
    burn: {
      ...
      faq: {
        items: [
          {
            q: '貢献ポイントの用途は？',
            a: 'ステーキング・債券などの収益を受取る際、貢献ポイントを 1:1 で消費します（gAGX 1 を受取ると 1 ポイント消費）。ポイントが不足すると受取れません。',
          },
          {
            q: '収益受取に貢献ポイントが必要な理由は？',
            a: '受取をプロトコルのデフレに結びつける仕組みです。gAGX を 1 受取るごとに貢献ポイント 1 を消費し、ポイントは AGX のバーンでのみ得られます。そのため収益の引出は必ず同量の AGX バーンに対応し、継続的に AGX のデフレを支えます。',
          },
          {
            q: 'バーン比率はいくらですか？',
            a: '1:6 の比率でバーンします。AGX を 1 枚バーンするごとに貢献ポイント 6 を得られます。バーンした AGX はブラックホールアドレスへ直接送られ、永久に流通から外れます。',
          },
          {
            q: 'バーンした AGX はどこへ行きますか？',
            a: 'バーンした AGX の 50% はブラックホールアドレスへ移され永久ロックされます。流通量を直接減らしデフレを強め、プロトコルの価値還元メカニズムの一部です。残る 50% はエコシステムトークン X の底池へ注入し、X の流動性深度と底池の安定性を高め、「収益 → バーン → 流動性強化」の価値の正の循環を構築します。',
          },
          {
            q: '貢献ポイントは譲渡や返金できますか？',
    ...
    turbine: {
      ...
      faq: {
        items: [
          ...
          {
            q: 'アンロックと引出の違いは？',
            a: 'アンロックは、現在価格で USD1 を使い同量の AGX を買い、ロック中の gAGX を解除してクールダウンを開始します。引出はクールダウン（24–96 時間）終了後、アンロック済み gAGX をウォレットへ移します。2つの手順はタービン記録で「アンロック」と「引出」として表示されます。',
          },
          {
            q: 'クールダウン時間はどのくらいですか？',
            a: 'アンロックのたびに 24–96 時間のクールダウンに入ります。具体的な時間は市場状態に応じてシステムが自動調整します。終了後、その gAGX をウォレットへ引き出せます。',
          },
          {
  ...
  genesis: {
    ...
    faq: {
      ...
      items: [
        {
          q: '共創プランへの参加方法は？',
          a: 'ユーザーはUSD1で共創に参加し、対応フェーズの割引でAGXを獲得できる。全3フェーズ、割引は30%、25%、20%の順。',
        },
        {
          q: '共創枠と参加条件は？',
          a: '最低参加額$100、100 USD1の整数倍で参加。各フェーズの枠は$100 – $10,000、$100 – $10,000、$100 – $30,000。',
        },
        {
          q: '共創のリリース期間は？',
        ...
        {
          q: 'Xエアドロップリワードの獲得方法は？',
          a: '単一アカウントの累計共創参加額が$1,000に達すると、対応フェーズのXエアドロップリワード資格を獲得。3フェーズのエアドロップ比率は5%、2%、1%の順。',
        },
        {
  ...
  rewards: {
    ...
    cards: {
      ...
      grant: {
        title: '発展手当',
        body: 'エコシステム発展特別手当',
        aside: '発展手当は AGX で承認不要。MarketFund 署名で受取り、ウォレットへ直送されます。',
      },
      genesis: {
        title: '創世共創リワード',
    ...
    referral: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: '紹介賞はどう受取りますか？',
            a: '左側の受取パネルで受取と再投資の配分を設定します。受取分はリリースプールに入り、選択した期間で線形リリースされます。再投資分は単一資産ステーキングへ直接入り複利します。受取も再投資も貢献ポイントを 1:1 で消費します。',
          },
          {
            q: '直接紹介アドレス数とは？',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: '左側の受取パネル上部で共創賞 / イコライズ賞を切り替え、受取と再投資の配分を設定します。受取分はリリースプールに入り、選択した期間で線形リリースされます。再投資分は単一資産ステーキングへ直接入り複利します。どちらも貢献ポイントを 1:1 で消費します。',
          },
          {
    ...
    grant: {
      claimIntoWallet: 'ウォレットへ直接入金',
      claimHint:
        '発展手当は AGX で支給され、承認不要でいつでもウォレットへ受取れます。貢献ポイントを消費せず、リリースプールもタービンも経由しません。',
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: '発展手当はどの形で支給されますか？',
            a: 'AGX です。蓄積後はアカウントに直接入り、承認不要でいつでもウォレットへ受取れます。',
          },
          {
            q: '手当の受取に承認は必要ですか？',
            a: '不要です。支給後は受取可能な状態です。受取ボタンを押せば AGX がウォレットへ入ります。サポートへアンロック申請する必要はありません。',
          },
          {
            q: '手当の受取に貢献ポイントは必要ですか？',
            a: '不要です。発展手当は他のリワードと異なり、受取時に貢献ポイントを消費せず、リリースプールもタービンも経由せず、AGX が直接ウォレットへ入ります。',
          },
          {
            q: '発展手当は何に使えますか？',
            a: '手当は市場開拓専用です。オフラインサロンやロードショー、コミュニティ運営・販促物、チャネル拡大など。エコシステム発展の実需に沿って使い、後で確認できるよう関連記録を残してください。',
          },
          {
            q: '手当の数量はどう計算されますか？',
            a: 'チームのステーキング変動と共創ランクに応じた手当比率で計上されます。チームが新規ステークすると比率分が蓄積され、チームが償還すると対応比率が蓄積額から差し引かれます。明細は手当記録の配布タブで確認できます。',
          },
          {
            q: '手当の数量が減った理由は？',
            a: 'チームメンバーがポジションを償還すると、対応比率が蓄積額から差し引かれ、配布記録に「償還」タイプの負数として表示されます。これは通常の算定です。',
          },
        ],
      },
    },
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: 'リワード受取に必要な条件は？',
          a: '受取には貢献ポイントを 1:1 で消費します（gAGX 1 を受取ると 1 ポイント消費）。ポイントは AGX をバーンして得られます。不足している場合は、先にバーンページで取得してください。',
        },
        {
          q: '受取したリワードはいつ着金しますか？',
        ...
        {
          q: 'リワードはいつ決済されますか？',
          a: 'ラッキー抽選は毎日 00:00（UTC）に決済されます。その他のリワードは Rebase に従い、約 12 時間ごとに同じ周期で決済されます。次回の支給時刻は各リワード詳細のデータパネルで確認できます。',
        },
        {
  ...
  community: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: '創世紹介報酬はどう計算されますか？',
          a: '創世紹介報酬は 3% で、圧縮同等額決済を採用し、同等額の部分のみを計算します。',
        },
        {
          q: '創世ランクをどう上げますか？',
          a: '個人の共創金額と体系業績の達成状況に基づき、S1 から S10 まで段階的に昇格します。',
        },
        {
          q: '体系発展手当の資格はどう得ますか？',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: '受取した収益は即時着金せず、選択した期間で線形リリースされます。期間が長いほど税率は低くなります：5日 20%、20日 10%、40日 5%、60日 1%。',
          },
          {
            q: '収益受取後はどこへ行きますか？',
          ...
          {
            q: '収益の再投資と受取の違いは？',
            a: '再投資はリリース期間をスキップし、収益が単一資産ステーキングへ直接入って複利を続けます。税率も有利（360日 15%、540日 10%）で、長期参加者向きです。受取はリリース期間をかけてウォレットへ着金し、より柔軟です。',
          },
          {
            q: 'バッファプールとは？',
            a: '元本をアンステークするとバッファプールに入り、30 日の二次線形リリースで短期の集中流出を抑えます。バッファ内の「リリース済み」分はいつでもウォレットへ償還できます。',
          },
        ],
      },
    },
      ...
      stake: {
        ...
        faq: {
          ...
          items: [
            {
              q: '受取と償還の違いは？',
              a: '受取は収益向け：蓄積した gAGX を選択したリリース期間で引き出すか、再投資します。償還は元本向け：リリース済み AGX 元本を取り出し、30 日バッファで二次線形リリースしたあとウォレットへ入ります。',
            },
            {
      ...
      lpbond: {
        ...
        faq: {
          ...
          items: [
            {
              q: '受取と償還の違いは？',
              a: '受取は収益向け：債券の gAGX 収益を選択リリース期間で引出、または直接再投資。償還は元本向け：リリース済み AGX 元本を取り出し、30 日バッファで二次線形リリース後にウォレット着金。',
            },
            {
              q: '「債券元本」はどう生じますか？',
            ...
            {
              q: '債券収益は再投資できますか？',
              a: 'できます。受取時にスライダーで再投資と受取の比率を自由配分。再投資分は選択期間（360/540 日）の単一資産ステーキングへ入り複利継続し、期間受取より税率が有利です。',
            },
            {
              q: 'カウントダウン終了後はどうなりますか？',
      ...
      xmine: {
        ...
        faq: {
          ...
          items: [
            {
              q: '産出受取とステーキング償還の違いは？',
              a: '受取はマイニング産出向け：X リワードはいつでも受取可能でリリース期間なし、ウォレットへ直入。償還はステーキング元本向け：gAGX 償還後はバッファに入り 30 日二次線形リリースし、バッファ内資産は収益を生みません。',
            },
            {
    ...
    hub: {
      ...
      faq: {
        ...
        items: [
          {
            q: 'Rebase はどう決済されますか？',
            a: 'プロトコルはブロックを基礎に運行：約 14,400 ブロック = 1 Epoch（約 12 時間）。各 Epoch 終了時に Rebase 決済を実行し、システムは1日 2 回収益を分配します。',
          },
          {
            q: '元本はどうリリースされますか？',
            a: 'ステーキングと債券の元本はブロック級線形リリース（約 3 秒/ブロックで連続決済）。リリース済み元本は引出後、30 日バッファリリースへ入り、二重線形で資金継続性と市場安定を両立します。',
          },
          {
      ...
      faq: [
        {
          ...
          a: '1日 2 回 Rebase、日次収益 0.5%–1%。期間が長いほどボーナスが高く：180 日 ≥10%、360 日 ≥15%、540 日 ≥20%。Rebase 係数と連動調整。',
        },
        {
          q: 'ステーキング元本はいつ引き出せますか？',
          a: '元本はブロック線形リリース（約 3 秒/ブロック）。リリース済み分はいつでも引出でき、引出後は 30 日バッファリリースへ入ります。',
        },
        {
          q: '参考 APY は固定ですか？',
    ...
    xmine: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'アンロック後の gAGX は 30 日のブロック線形リリースで、アンステーク後の集中売圧を抑え、長期の価値捕捉を強めます。',
        },
        {
          q: 'X の総量は？増発しますか？',
  ...
  release: {
    ...
    faq: {
      ...
      buffer: [
        {
          q: 'バッファプールとは？',
          a: '元本をアンステーク（償還）するとバッファプールに入り、30 日の二次線形リリースが行われます。短期の集中流出を抑え、継続的なリリースと市場安定のバランスを取ります。',
        },
        {
