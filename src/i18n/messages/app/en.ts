...
const app = defineMessages({
  ...
  nav: {
    ...
    proposalTooltip: 'Take part in protocol proposals and voting.',
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: 'After connecting, your proposal votes will appear here.',
  ...
  community: {
    ...
    cobuildLevel: 'Co-build level',
    makingLevel: 'Co-build level',
