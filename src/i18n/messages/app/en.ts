...
const app = defineMessages({
    ...
    genesis: {
        ...
        xTokenAirdropHint: 'Per-Phase cumulative co-build amount ≥ {threshold} qualifies for airdrop rewards',
        join: 'Join co-build',
        ...
        purchaseUnavailable: 'Subscription is currently unavailable. Check your shares or phase status.',
