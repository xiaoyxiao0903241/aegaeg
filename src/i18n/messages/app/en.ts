...
const app = defineMessages({
    ...
    rewards: {
        ...
        superCommunityBenefitBody: 'Super Communities receive a dedicated development fund and governance rights.',
        ...
        communityFundTooltip: 'Super communities receive 5% of system development fund, dedicated to system self-operation, including but not limited to: system building, daily operations, system meetings, and system lecturers.',
