...
const app = defineMessages({
  ...
  nav: {
    ...
    rewards: '리워드',
    community: '커뮤니티',
    genesisTooltip: 'Genesis 구독 시즌에 참여하고 주주 칭호를 획득하세요.',
  ...
  swap: {
    title: 'Swap',
    intro: 'PancakeSwap 실시간 시장 환율, 온체인에서 즉시 정산.',
    ...
    swapSuccess: '스왑 완료',
    connectToSwap: '지갑 연결 후 스왑',
    connectExploreTitle: '연결 후 AEGIS X 기능 탐색',
    ...
    about: {
      title: '안내',
      body: 'USDT와 USD1을 고정 1:1 환율로 즉시 스왑하며 슬리피지가 없습니다. USD1은 AEGIS X 프로토콜의 핵심 정산 자산입니다.',
    },
    tokenAbout: {
      ...
      items: [
        {
          key: 'usd1',
          title: 'USD1 · 핵심 정산 자산',
          body: 'AEGIS X 생태계 핵심 정산 자산으로, 가치 유통, 유동성 네트워크 및 결제 시나리오를 연결합니다.',
        },
        {
          key: 'agx',
          title: 'AGX · 핵심 프로토콜 자산',
          body: 'AGX는 AEGIS X 프로토콜 핵심 자산으로, 150% 초과 담보 메커니즘을 통해 생성되며 가치 성장, 수익 분배 및 생태계 구축의 중요한 역할을 담당합니다.',
          bodyDesktop:
            'AEGIS X 프로토콜 핵심 거버넌스 및 가치 토큰으로, 거버넌스 투표, 스테이킹 및 생태계 인센티브에 사용되어 프로토콜의 장기 성장 가치를 담습니다.',
        },
        {
          key: 'gagx',
          title: 'gAGX · 리워드 정산 증명',
          body: '프로토콜 리워드 정산 증명으로, AGX로 교환 가능하며 생태계 마이닝 및 수익 재순환에 참여할 수 있습니다.',
          bodyDesktop: 'AGX 스테이킹으로 얻는 이자형 증명으로, 자동 복리 수익과 거버넌스 가중치 및 상위 칭호를 해제합니다.',
        },
        {
          key: 'x',
          title: 'X · 생태계 가치 토큰',
          body: 'AEGIS X 생태계 가치 매개체로, 고정 총량 2.1억 개이며 생태계 성장과 가치 축적을 담습니다.',
          bodyDesktop: '생태계 참여 및 지분 토큰으로, 온체인 기여를 기록하며 혜택 교환, 이벤트 참여 및 에어드롭 배수를 제공합니다.',
        },
      ],
    },
  ...
  genesis: {
    ...
    hint: '이번 시즌 32지분 추가 구독 가능 · 전체 네트워크 40지분 남음',
    quota: '이번 기 공동 구축 한도',
    pay: '지불',
    receive: '획득 AGX',
    value: '구독 가치',
    ...
    connectBrandLine: '미래 가치 네트워크를 수호하세요',
    contributionsConnectTitle: '지갑을 연결하여 기록을 확인하세요',
    contributionsConnectBody: '연결 후 공동 구축 기록이 여기에 표시됩니다.',
    totalContributed: '누적 공동 구축',
  ...
  rewards: {
    ...
    currentTitle: '현재 등급',
    shareholder: 'S2 · 창세 주주',
    shareholderHint: '팀 구독 2% 리워드 · 출시 후 A3 칭호 30일',
    ...
    shareholderNoRankBody:
      '창세 주주가 되면 팀 공동 구축 금액의 1%-10%를 리워드로 받을 수 있으며, AEGIS X 출시 후 30일 이내 1단계 승급됩니다.',
    shareholderTitleForRank: '{rank} · 창세 주주',
    heroKicker: '창세 등급',
    heroBody: '팀 구독 금액에 대해 {bonus} 리워드를 받으며, 출시 후 30일간 {postLaunch} builder 칭호를 획득합니다.',
    heroBodyForRank:
      '팀 구독 금액에 대해 {bonus} 리워드를 받으며, 출시 후 30일간 {postLaunch} builder 칭호를 획득합니다.',
    currentTierSuffix: '현재',
    progressPersonalTo: '{rank}까지 · 개인 구독',
    progressTeamTo: '{rank}까지 · 팀 구독',
    ...
    allTiers: '창세 명예 체계',
    history: '리워드 기록',
    historyConnectBody: '연결 후 리워드 기록이 여기에 표시됩니다.',
  ...
  community: {
    ...
    referralBondActiveSince: '{date}부터 추천 관계 활성화 · 연결은 영구적입니다.',
    volumePrefix: '실적',
  ...
  status: {
    loading: '로딩 중…',
    signInRequired: '서명 로그인 후 개인 데이터 확인',
  },
