...
const app = defineMessages({
  ...
  onboarding: {
    ...
    steps: [
      ...
      {
        title: '단일 자산 스테이킹',
        body: '「스테이킹」 카드에서 AGX를 스테이킹하세요. 하루 2회 Rebase로 복리 성장하며, 주기가 길수록 수익률 가산이 높아집니다.',
      },
      {
        title: '자산',
  ...
  staking: {
    ...
    hub: {
      modes: {
        stake: {
          title: '스테이킹',
          body: 'AGX 스테이킹 — 하루 2회 Rebase 복리 성장',
        },
        lpbond: {
          title: 'LP 채권',
      ...
      overview: {
        ...
        metrics: [
          ...
          },
          {
            id: 'rebase',
            label: '현재 Rebase 수익률',
            hint: 'Epoch마다(약 12시간) 한 번 정산되며 프로토콜 상태에 따라 동적으로 조절됩니다',
          },
          {
            id: 'runway',
            label: '런웨이',
    ...
    stake: {
      title: '스테이킹',
      intro: 'AGX 스테이킹 · 하루 2회 Rebase 복리 성장',
      ...
      mechanismSteps: [
        ...
        {
          title: '일일 Rebase 수익',
          body: 'Epoch마다(약 12시간) 자동 정산되며 수익은 gAGX로 복리 누적됩니다.',
        },
        {
          title: '만기 릴리스와 수령',
  ...
  release: {
    ...
    hub: {
      ...
      mechanismSteps: [
        ...
        { title: '6 : 1 기여 메커니즘', body: '50% 소각 · 50% X 기반 풀 주입' },
