...
const app = defineMessages({
    ...
    nav: {
        ...
        communityTooltip: '파트너를 초대하여 공동 구축에 참여하고, 생태계 성장 가치와 창세 리워드를 함께 누리세요.',
    ...
    swap: {
        ...
        hub: {
            modes: {
                flash: {
                    title: '플래시 스왑',
                    body: '수수료/슬리피지 없이 USDT를 USD1로',
                },
                trade: {
                    title: '거래',
                    body: '주요 토큰을 AEGIS X 토큰으로 스왑',
                },
                burn: {
                    title: '소각',
            ...
            about: {
                title: '스왑 안내',
                body: 'USDT를 USD1로 스왑하고, X DAO 자산을 거래하거나 gAGX를 AGX로 업그레이드하고 AGX 소각으로 포인트를 얻습니다.',
            },
            program: {
                title: 'X DAO 토큰 받기',
                cards: [
                    { title: '플래시 스왑', body: 'USDT를 USD1로 스왑' },
                    { title: 'Get USD1', body: 'PancakeSwap 시장가로 USD1 받기' },
                    { title: 'Get AGX', body: 'PancakeSwap 시장가로 AGX 받기' },
                    { title: 'X 판매', body: 'X를 AEGIS X 자산 또는 주요 토큰으로 스왑' },
                    { title: '포인트 받기', body: 'AGX를 1:6 비율로 소각해 포인트 받기' },
                ],
            },
            faq: {
                items: [
            ...
            tabs: {
                ...
                agx: {
                    ...
                    items: [
                        {
                            q: 'AGX란?',
                            a: 'AGX는 프로토콜 핵심 자산으로, 150% 초과 담보 메커니즘을 통해 발행되며 가치 성장, 수익 분배 및 생태계 구축을 담당합니다.',
                        },
                        {
                            q: 'AGX는 어떻게 지속적인 성장을 실현하나요?',
                            a: '스테이킹, 본드 및 Rebase를 통해 장기 복리 순환을 형성하고, AI 싱크탱크의 마켓메이킹과 매입 소각을 결합합니다.',
                        },
                        {
                            q: 'AGX는 어떻게 획득하나요?',
                            a: '사용자는 프로토콜 생태계 참여를 통해 AGX를 획득할 수 있으며, 프로토콜이 지원하는 거래 시장을 통해서도 획득할 수 있습니다.',
                        },
                    ],
                },
                gagx: {
                    ...
                    items: [
                        {
                            q: 'gAGX란?',
                            a: 'gAGX는 프로토콜 리워드 정산 증명으로, 수익 성장과 생태계 가치를 연결하며 생태계 마이닝에 참여할 수 있습니다.',
                        },
                        {
                            q: 'gAGX는 어떻게 획득하나요?',
                            a: '사용자가 프로토콜 수익 분배에 참여하면 그에 상응하는 수량의 gAGX를 획득할 수 있습니다.',
                        },
                        {
                            q: 'gAGX와 AGX의 차이는 무엇인가요?',
                            a: 'AGX는 핵심 자산으로 가치 성장과 수익 분배를 담당하며, gAGX는 생태계 수익 증명으로 AGX로 교환할 수 있고 생태계 마이닝 참여의 진입점 역할을 합니다.',
                        },
                    ],
                },
                x: {
                    ...
                    items: [
                        {
                            q: 'X란?',
                            a: 'X는 AEGIS X 생태계 가치 토큰으로, 총량이 2억 1천만 매로 고정되어 생태계 성장과 가치 축적을 담당합니다.',
                        },
                        {
                            q: 'X는 어떻게 획득하나요?',
                            a: '사용자는 생태계 마이닝 참여를 통해 X 리워드를 획득하고 생태계 성장 가치를 공유할 수 있습니다.',
                        },
                        {
                            q: 'X 에어드롭은 어떻게 릴리스되나요?',
                            a: 'X의 가치는 생태계 성장, 가치 축적 및 장기 발전 합의에서 비롯됩니다.',
                        },
                    ],
                },
            },
    ...
    genesis: {
        ...
        xTokenAirdropHint: '시즌 누적 공동 구축 금액 ≥ {threshold} 시 에어드롭 보상 자격이 부여됩니다.',
        join: '공동 구축 참여',
        ...
        errors: {
            ...
            phaseInactive: '이 시즌은 시작되지 않았거나 종료되었습니다.',
            belowMin: '금액이 이 시즌의 최소 금액보다 낮습니다.',
            soldOut: '이 시즌은 매진되었습니다.',
            userLimitExceeded: '이 시즌의 지갑당 한도를 초과했습니다. 금액을 줄이세요.',
            invalidPhase: '유효하지 않은 시즌입니다.',
    ...
    rewards: {
        ...
        superCommunityBenefitBody: '슈퍼 커뮤니티는 체계 발전 전용 기금과 거버넌스 권익을 받습니다.',
        ...
        communityFund: '발전 기금',
        communityFundTooltip: '슈퍼 커뮤니티는 체계 발전 기금의 5%를 받으며, 시스템 구축, 일상 운영, 체계 회의, 체계 강사 등 체계 자영에 전용됩니다.',
