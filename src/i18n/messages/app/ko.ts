...
const app = defineMessages({
        ...
        items: [
          {
            ...
            a: '플래시로 USDT→USD1, gAGX→AGX 교환, PancakeSwap에서 AEGIS X 생태계 토큰 거래, AGX 소각으로 기여 포인트 획득, USD1로 터빈 잠금 해제 gAGX 매수가 가능합니다.',
          },
          {
            q: '플래시와 거래의 차이는 무엇인가요?',
            a: '플래시는 프로토콜 고정 경로로 사용자 슬리피지 설정이 없습니다. 거래는 PancakeSwap 실시간 환율을 쓰며 슬리피지를 설정할 수 있고 시장 가격 영향이 있을 수 있습니다.',
          },
          {
    ...
    flash: {
      ...
      faq: {
        items: [
          {
            q: 'gAGX란 무엇인가요?',
            a: 'gAGX는 Rebase와 DAO 리워드의 통합 정산 증표입니다. AGX 스테이킹·채권의 Rebase 수익과 각종 DAO 리워드는 gAGX로 지급됩니다.',
          },
          {
            q: 'gAGX와 AGX의 교환 비율은?',
          ...
          {
            q: 'gAGX는 어떻게 얻나요?',
            a: '프로토콜 수익 분배에 참여하면 해당 수량의 gAGX를 받습니다.',
          },
          {
            q: 'gAGX는 AGX 교환 외에 무엇을 할 수 있나요?',
            a: '언제든 1:1로 AGX로 교환해 스테이킹 복리에 참여하거나, gAGX를 스테이킹해 X를 채굴할 수 있습니다. 두 경로를 자유롭게 선택할 수 있습니다.',
          },
          {
            q: 'USDT를 USD1로 어떻게 교환하나요?',
            a: '플래시 상단에서 「USDT → USD1」 페어로 전환한 뒤 수량을 입력하면 프로토콜 환율로 교환되며 온체인에 즉시 반영됩니다.',
          },
          {
            q: 'USD1을 USDT로 다시 교환할 수 있나요?',
            a: '플래시 경로는 단방향 USDT→USD1입니다. 다른 자산으로 바꾸려면 거래 페이지의 시장 교환을 이용하세요.',
          },
          {
            q: '플래시 기록은 어디서 확인하나요?',
            a: '플래시는 온체인에서 체결되며 초 단위로 반영됩니다. 지갑 또는 블록 탐색기에서 각 거래를 확인해 주세요.',
          },
        ],
      },
    },
    ...
    burn: {
      ...
      faq: {
        items: [
          {
            q: '기여 포인트는 어디에 쓰이나요?',
            a: '혼합 수익 수령·재예치 등에 기여 포인트가 필요합니다. 잔액이 부족하면 수령이 실패하므로 먼저 AGX를 소각해 보충하세요.',
          },
          {
            q: '수익 수령에 기여 포인트가 필요한 이유는?',
            a: '프로토콜은 기여 포인트로 수령·재예치 자격을 제한합니다. 잔액이 부족하면 수령이 되돌아가므로 — 먼저 AGX를 소각해 포인트를 추가하세요.',
          },
          {
            q: '소각 비율은 얼마인가요?',
            a: '소각 비율은 온체인 rateBps로 설정됩니다. 기여 포인트 = 소각 AGX × rateBps ÷ 10000.',
          },
          {
            q: '소각된 AGX는 어디로 가나요?',
            a: '온체인 분할 설정에 따라 약 {burnPct}%는 블랙홀로 영구 소각되고, 약 {injectPct}%는 LP 유동성에 주입될 수 있습니다.',
          },
          {
            q: '기여 포인트를 양도하거나 환불할 수 있나요?',
            a: '기여 포인트는 AgxContributionSwap 컨트랙트 계정 장부에 기록되며, 양도할 수 없고 AGX로 환불할 수도 없습니다.',
          },
        ],
      },
    },
      ...
      faq: {
        items: [
          ...
          },
          {
            ...
            a: '잠금 해제는 USD1로 현재 가격에 동일 수량의 AGX를 매수해야 합니다(수량 1:1). 지불 USD1 금액은 AGX 호가에 따라 변하며, USD1:AGX 가격이 고정 1:1은 아닙니다.',
          },
          {
            q: '잠금 해제와 출금의 차이는?',
            a: '잠금 해제: USD1로 AGX를 매수하고 쿨다운을 시작합니다. 출금: 쿨다운 만료 후 gAGX를 지갑으로 수령합니다.',
          },
          {
            q: '쿨다운은 얼마나 걸리나요?',
          ...
          },
          {
            ...
            a: '매수한 AGX는 지갑으로 입금됩니다. 쿨다운이 만료된 후 gAGX를 별도로 수령합니다.',
          },
        ],
      },
    },
  ...
  rewards: {
    ...
    hub: {
      ...
      mechanismFooter:
        '임의 두 라인 메커니즘: 임의 두 라인이 해당 등급에 도달하면 승급합니다. 등급이 높을수록 보너스 비율이 높으며, 최고는 평생 성취상과 글로벌 배당입니다.',
      aboutSlides: {
        lucky: {
          title: '럭키',
          body: '블록 럭키 추첨으로 행운의 공동 구축자에게 무작위 지급; 당첨 후 Mixed로 수령.',
        },
        referral: {
          title: '추천',
        ...
        cobuild: {
          title: '공동 구축',
          body: '팀 협업과 장기 공동 구축으로 만드는 지속 가능 인센티브; 등급 비율로 배분, Mixed 수령 시 기여 포인트 필요.',
        },
        grant: {
          title: '성장 지원금',
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: '가능합니다. 매뉴얼에 따르면 유동 스테이킹(liquidStake)도 단일 금액이 기준에 도달하면 당일 자격에 반영됩니다. 자격은 단일 거래 기준이며 여러 건을 합산하지 않습니다. 당일 유동 한도 때문에 단일 금액이 기준에 못 미치면 해당 건은 자격을 얻지 않습니다.',
          },
        ],
      },
    },
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: '개인 공동 구축 금액과 체계 실적에 따라 S1에서 S10까지 단계적으로 승급합니다.',
          },
          {
            q: '등급 향상 리워드란?',
            a: '등급 리워드는 현재 제네시스 등급 비율로 팀 공동 구축 금액을 정산하며, 수령 가능 한도는 RewardClaimer 서명으로 지갑에 수령합니다.',
          },
          {
            q: '제네시스 팀 리워드는 어떻게 정산되나요?',
            a: '직추천 리워드는 지갑으로 자동 정산됩니다. 등급 리워드와 발전 기금은 각각 RewardClaimer / CommunityFund 서명으로 수령합니다.',
          },
        ],
      },
    },
    ...
    faq: {
      ...
      items: [
        {
          q: '리워드는 어떤 형태로 지급되나요?',
          a: '대부분 리워드는 AGX / gAGX 기준으로 표시되며, 제네시스 공동 구축 리워드는 RewardClaimer 자산으로 지급됩니다. Mixed 수령 시 릴리스분은 릴리스 풀로 들어갑니다.',
        },
        {
          q: '리워드 수령에 필요한 조건은?',
          a: '단순 서명 리워드는 수령 가능 잔액과 유효 서명이 필요합니다. Lucky / DaoPool Mixed는 충분한 기여 포인트와 릴리스/재예치 비율 선택도 필요합니다.',
        },
        {
          q: '수령한 리워드는 언제 입금되나요?',
          a: '온체인 거래 확인 후 입금됩니다. 릴리스분은 선택한 주기로 선형 릴리스되고, 재예치분은 해당 재예치 포지션으로 들어갑니다.',
        },
        {
          q: '리워드는 언제 정산되나요?',
          a: '각 리워드 출처는 컨트랙트와 백엔드 스캔 규칙으로 정산됩니다. 프론트엔드는 수령 가능 잔액과 서명 페이로드를 기준으로 합니다.',
        },
        {
          q: '일부 리워드 카드에 금액이 표시되지 않는 이유는?',
          a: '미연결 또는 미서명 로그인 시에는 로그인 안내가 표시되며, 리워드가 없다는 뜻이 아닙니다. 로그인 후에도 — 이면 현재 수령 가능 항목이 없거나 데이터가 아직 준비되지 않은 것입니다.',
        },
      ],
    },
  ...
  assets: {
    ...
    blocked: {
      ...
      insufficientContribution: '기여값이 부족합니다. 먼저 기여 포인트로 교환해 주세요',
    ...
    position: {
      ...
      activateWarmup: '워밍업 활성화',
      activateWarmupSuccess: '워밍업 활성화됨',
    ...
    claim: {
      ...
      taxRate: '세율 {rate}%',
      contribNeed: '이번 수령에 차감할 기여값 {amount}',
      contribShort: '기여값이 부족합니다. 먼저 소각으로 기여 포인트를 교환해 주세요',
      goBurn: '소각 교환으로 이동',
      ctaMixed: '수령 & 재예치',
      ctaRelease: '수령',
      ctaRestake: '재예치',
        ...
        items: [
          {
            ...
            a: '각 제품 포지션 원금과 미출금 수익 평가를 합산합니다. 교차 제품 호가가 없으면 — 로 표시됩니다. 지갑 유휴 잔액은 포함되지 않습니다.',
          },
          {
            q: '수익은 어떤 형태로 지급되나요?',
            a: '스테이킹·채권 Rebase 수익은 gAGX로, X 마이닝 산출은 X로 지급됩니다.',
          },
          {
            q: '수익을 수령할 수 없는 이유는?',
            a: 'Mixed 수령은 기여값을 소모합니다. 부족하면 먼저 AGX를 소각해 기여값을 얻은 뒤 수령하세요.',
          },
          {
            q: '기여값은 어떻게 얻나요?',
          ...
          },
          {
            ...
            a: '수령한 수익은 릴리스 풀에서 선택한 주기로 선형 릴리스되며, 주기가 길수록 세율이 보통 더 낮습니다.',
          },
          {
            q: '수익 수령 후 어디로 가나요?',
            a: '즉시 지갑에 입금되지 않고 RewardQueue / 릴리스 풀에서 주기 릴리스됩니다. 릴리스된 분은 릴리스 페이지에서 수령할 수 있습니다.',
          },
          {
            q: '수익 재예치와 수령의 차이는?',
            a: '재예치는 수익을 재예치 포지션에 넣어 계속 이자를 붙일 수 있고, 수령은 릴리스 주기에 따라 점진 입금되어 더 유연합니다.',
          },
          {
            q: '버퍼 풀이란?',
      ...
      stake: {
        ...
        faq: {
          ...
          items: [
            {
              q: '수령과 상환의 차이는?',
              a: '수령은 수익을 처리하고(재예치 분기 가능), 상환은 원금을 릴리스 버퍼로 보냅니다.',
            },
            {
              q: '릴리스됨이란 무엇인가요?',
              a: '잠긴 스테이킹이 만기된 후 상환할 수 있는 원금입니다.',
            },
            {
              q: '왜 스테이킹마다 따로 표시되나요?',
              a: '각 개설 포지션은 이자와 릴리스 진행을 독립 계산하므로 포지션별로 수령·상환할 수 있습니다.',
            },
            {
              q: '카운트다운이 끝나면 어떻게 되나요?',
              a: '남은 시간이 0이 되면 해당 포지션이 상환/조작 가능 상태가 됩니다. 온체인 상태를 기준으로 하세요.',
            },
            {
              q: '수령 시 재예치 비율은 어떻게 쓰나요?',
              a: '슬라이더로 릴리스와 재예치 비율을 나누고, 릴리스·재예치 주기를 선택한 뒤 확인해 주세요.',
            },
          ],
        },
      },
      lpbond: {
        ...
        faq: {
          ...
          items: [
            {
              q: '수령과 상환의 차이는?',
              a: '수령은 수익용: 채권에서 생긴 gAGX 수익을 선택한 릴리스 주기로 수령하거나 바로 재예치합니다. 상환은 원금용: 릴리스된 AGX 원금을 꺼내 {days}일 버퍼에서 2차 선형 릴리스 후 지갑에 입금됩니다.',
            },
            {
              q: '「채권 원금」은 어디서 오나요?',
            ...
            {
              q: '채권 수익을 재예치할 수 있나요?',
              a: '가능합니다. 수령 시 슬라이더로 재예치와 수령 비율을 나눕니다. 재예치분은 선택한 주기({restakeDays}일) 단일 자산 스테이킹으로 들어가 계속 복리되며, 세율이 주기 수령보다 유리합니다.',
            },
            {
              q: '카운트다운이 끝나면 어떻게 되나요?',
          ...
          items: [
            {
              ...
              a: '수령은 마이닝 산출용: X 리워드는 언제든 수령·릴리스 주기 없이 지갑으로 바로 입금됩니다. 상환은 스테이킹 원금용: gAGX 상환 후 버퍼에서 {days}일 2차 선형 릴리스되며, 버퍼 자산은 더 이상 수익을 내지 않습니다.',
            },
            {
    ...
    hub: {
      ...
      faq: {
        ...
        items: [
          {
            q: 'Rebase는 어떻게 정산되나요?',
            a: '프로토콜은 블록 기반으로 실행됩니다. 약 {blocks} 블록 = 1 Epoch(약 {hours}시간). 각 Epoch 종료 시 Rebase 정산이 실행되며, 시스템은 하루 {timesPerDay}회 수익을 분배합니다.',
          },
          {
            q: '원금은 어떻게 릴리스되나요?',
            a: '스테이킹·채권 원금은 블록 단위 선형 릴리스(약 3초/블록)입니다. 출금 후 릴리스된 원금은 {days}일 버퍼 릴리스로 들어가, 이중 선형 릴리스로 자금 연속성과 시장 안정성을 맞춥니다.',
          },
          {
      ...
      faq: [
        {
          ...
          a: '하루 {timesPerDay}회 Rebase, 일 수익 약 0.5%–1%. 주기가 길수록 가산이 큽니다: 180일 ≥10%, 360일 ≥15%, 540일 ≥20%, Rebase 계수와 연동됩니다.',
        },
        {
          q: '스테이킹 원금은 언제 출금할 수 있나요?',
          a: '원금은 블록 선형으로 릴리스됩니다(약 3초/블록). 릴리스된 분은 언제든 출금할 수 있으며, 출금 후 {days}일 버퍼 릴리스로 들어갑니다.',
        },
        {
          q: '참고 APY는 고정인가요?',
    ...
    xmine: {
      ...
      faq: [
        ...
        },
        {
          ...
          a: '잠금 해제된 gAGX는 약 30일 블록 선형 릴리스로 집중 매도 압력을 줄이고 장기 가치 캡처를 강화합니다.',
        },
        {
          q: 'X 총량은 얼마인가요? 추가 발행되나요?',
          a: 'X 총 발행량 2.1억 개 고정, 추가 발행 없음. 47.62%는 LP 유동성 구축, 52.38%는 글로벌 리워드와 성장에 사용됩니다.',
        },
        {
          q: 'gAGX는 어떻게 얻나요?',
          a: 'gAGX는 Rebase와 DAO 리워드의 통합 정산 증표입니다. AGX 스테이킹·채권의 Rebase 수익과 각종 DAO 리워드는 gAGX로 지급됩니다.',
        },
        {
          ...
          a: '언제든 1:1로 AGX 교환해 스테이킹 복리에 참여하거나, gAGX를 스테이킹해 X를 채굴할 수 있습니다.',
        },
        {
          q: 'X는 왜 지속 디플레이션인가요?',
          a: 'X 매도 거래마다 25%가 자동 소각됩니다. 생태계 성장으로 수요와 유통이 늘고 소각이 누적되어 장기 디플레이션 순환이 형성됩니다.',
        },
        {
          q: 'X의 가치 원천은?',
          a: '세 가지 수요가 겹칩니다. gAGX 스테이킹 마이닝의 X 수요, 플랫폼 수익 환류, 앱 확장과 사용자 성장이 X 수요를 강화합니다.',
        },
        {
          q: '스테이킹 상한이 채권/장기 스테이킹 보유와 연동되는 이유는?',
          a: '이 메커니즘은 X 마이닝 참여자가 동시에 프로토콜의 장기 건설자이도록 합니다. 채권 또는 장기 스테이킹 보유를 늘리면 마이닝 상한이 올라갑니다. 컨트랙트는 miningQuotaOf로 한도를 반환합니다.',
        },
      ],
    },
    calc: {
  ...
  release: {
    ...
    faq: {
      ...
      hub: [
        {
          q: '릴리스 주기를 변경할 수 있나요?',
          a: '이미 큐에 들어간 금액의 주기는 변경할 수 없습니다. 새 수령은 다른 주기를 고를 수 있습니다.',
        },
        {
          q: '세율은 언제 차감되나요?',
          a: '선택한 릴리스 계획의 요율로, 릴리스된 분을 수령할 때 차감됩니다.',
        },
        {
          q: '릴리스 풀에서 수령한 gAGX는 어디로 가나요?',
          a: '온체인에서는 AGX로 터빈 매도 할당량에 들어가며, 이후 터빈 흐름으로 gAGX를 얻습니다.',
        },
        {
          q: '릴리스된 분을 바로 수령하지 않으면 손실이 있나요?',
          a: '없습니다. 잠금 해제된 분은 언제든 수령할 수 있으며 지연으로 감쇠하지 않습니다.',
        },
        {
          q: '적절한 릴리스 주기는 어떻게 고르나요?',
          a: '주기가 길수록 세율이 낮습니다. 유동성 필요에 따라 5/20/40/60일 중에서 선택하세요.',
        },
      ],
      queue: [
        {
        ...
        {
          q: '릴리스 풀에서 수령한 gAGX는 어디로 가나요?',
          a: '터빈 할당량으로 들어가며, 교환 → 터빈으로 이동해 사용하세요.',
        },
        {
          q: '릴리스된 분을 바로 수령하지 않으면 손실이 있나요?',
          a: '없습니다.',
      ...
      buffer: [
        ...
        {
          q: '버퍼 풀 자산에도 수익이 있나요?',
          a: '버퍼 기간에는 스테이킹 수익이 더 이상 발생하지 않습니다.',
        },
        {
          q: '릴리스된 분은 어떻게 출금하나요?',
          a: '출금을 누르면 AGX가 지갑으로 바로 입금됩니다.',
        },
        {
          q: '버퍼 풀에 AGX와 gAGX 두 자산이 보이는 이유는?',
          a: '디자인상 이중 카드를 유지합니다. 온체인 버퍼는 gAGX 환산 후 AGX만 정산합니다.',
        },
        {
          q: '이미 릴리스된 자산을 한 번에 모두 출금할 수 없는 이유는?',
          a: '현재 잠금 해제된 한도만 출금할 수 있습니다. 만기되지 않은 부분은 계속 기다려야 합니다.',
        },
      ],
    },
  },
