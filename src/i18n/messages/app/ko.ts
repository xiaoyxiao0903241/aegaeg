...
const app = defineMessages({
    ...
    swap: {
        ...
        hub: {
            modes: {
                flash: {
                    title: '전환',
                    body: '수수료/슬리피지 없이 USDT를 USD1로 전환',
                },
                trade: {
                    title: '거래',
            ...
            program: {
                title: 'X DAO 토큰 받기',
                cards: [
                    { title: '전환', body: 'USDT를 USD1로 전환' },
                    { title: 'USD1 받기', body: 'PancakeSwap 시장가로 USD1 받기' },
                    { title: 'AGX 받기', body: 'PancakeSwap 시장가로 AGX 받기' },
        ...
        flash: {
            title: '전환',
            intro: 'USDT를 USD1로 전환, 수수료 없음, 슬리피지 없음',
            providerName: 'AEGIS X',
            openProvider: 'BscScan에서 전환 계약 보기',
    ...
    genesis: {
        ...
        xTokenAirdropHint: '페이즈 누적 공동 구축 금액 ≥ {threshold} 시 에어드롭 보상 자격이 부여됩니다.',
        join: '공동 구축 참여',
