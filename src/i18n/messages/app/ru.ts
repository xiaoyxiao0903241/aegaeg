...
const app = defineMessages({
    ...
    wallet: {
        ...
        transactionErrors: {
            gasLimitTooLow: 'Слишком низкий лимит gas. Оставьте в кошельке достаточно BNB для сетевой комиссии и повторите попытку.',
            ...
            items: [
                {
                    ...
                    a: 'Пользователи участвуют в со-строительстве с USD1 и получают AGX со скидкой соответствующего этапа. {phaseCount} сезона, скидки: {discounts}.',
                },
                {
