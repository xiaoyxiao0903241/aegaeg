  ...
  exchange: {
    ...
    hub: {
      modes: {
        ...
        turbine: {
          title: 'Турбина',
          body: 'Купить разблокированный gAGX в Турбине 1:1 за USD1',
        },
        comingSoon: 'Скоро',
      },
      about: {
      ...
      program: {
        ...
        cards: [
          { title: 'Обмен gAGX', body: 'Обменять gAGX на AGX' },
          { title: 'Турбина', body: 'Купить разблокированный gAGX в Турбине за USD1' },
          { title: 'Получить USD1', body: 'Конвертировать USDT в USD1 через Flash' },
          ...
          { title: 'Получить очки вклада', body: 'Сжечь AGX 1:6 за очки вклада' },
        ],
      },
      ...
      faq: {
        items: [
          {
            q: 'Что можно делать на странице Swap?',
            a: 'Flash: USDT→USD1 (и gAGX→AGX), торговля активами AEGIS X на PancakeSwap, сжигание AGX за очки вклада и покупка разблокированного gAGX Турбины за USD1.',
          },
          {
            q: 'Чем Flash отличается от Trade?',
            a: 'Flash — фиксированный маршрут протокола без пользовательского slippage. Trade — живые курсы PancakeSwap с настраиваемым slippage и влиянием на цену.',
          },
