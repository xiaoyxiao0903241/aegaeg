  ...
  exchange: {
    ...
    hub: {
      modes: {
        flash: {
          title: 'Конвертация',
          body: 'Конвертация USDT в USD1 без комиссии и slippage',
        },
        trade: {
          title: 'Торговля',
    ...
    flash: {
      title: 'Конвертация',
      intro: 'Конвертация USDT в USD1 без комиссии и проскальзывания',
      providerName: 'AEGIS X',
      openProvider: 'Открыть контракт конвертации на BscScan',
