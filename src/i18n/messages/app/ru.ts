...
const app = defineMessages({
    ...
    rewards: {
        ...
        superCommunityBenefitBody: 'Суперсообщества получают целевой фонд развития и права управления.',
        ...
        communityFundTooltip: 'Суперсообщества получают 5% фонда развития системы для самообеспечения системы, включая, но не ограничиваясь: строительство системы, ежедневные операции, системные встречи и системных лекторов.',
