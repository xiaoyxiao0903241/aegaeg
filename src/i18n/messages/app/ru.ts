...
const app = defineMessages({
    ...
    genesis: {
      ...
      xTokenAirdropHint: 'Награды аирдропа доступны при накопленном участии в со-строительстве ≥ {threshold} на аккаунт за сезон.',
    ...
    rewards: {
      ...
      heroBodyForRank: 'Сумма командной подписки приносит награду {bonus}, а после запуска — статус builder {postLaunch} на 30 дней.',
      ...
      teamQualifiedPartitionsLabel: 'Линия {rank}',
    ...
    community: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: 'Как получить право на фонд развития организации?',
            a: 'Когда совокупный объём со-строительства организации достигает 1 000 000 USD, вы получаете 5% поддержки фонда развития организации.',
          },
        ],
      },
    },
