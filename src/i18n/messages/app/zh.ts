  ...
  proposal: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: '投票会锁定我的 AGX 吗？锁多久？',
          a: '会。参与投票需锁定 AGX，锁定期至该提案投票期结束为止。投票期结束后在「我的投票记录」中点击「解锁」即可解锁，无额外冷却期，解锁后可自由使用。',
        },
        {
          q: '投票能获得什么奖励？',
        ...
        {
          q: '提案奖励如何领取？',
          a: '提案投票期结束、结果结算完成后，该笔奖励在「提案奖励记录」中变为可领取状态，点击「领取」即直接到账钱包——不消耗贡献点数，也不经过涡轮。提案进行中时显示为进行中。',
        },
        {
          q: '谁可以发起提案？',
        ...
        {
          q: '每个提案可以投几次票？',
          a: '同一提案可在投票期内多次投票，每次投票需追加锁定 AGX，投票权按累计锁定数量计算，可分别投给赞成与反对。',
        },
      ],
    },
    lock: {
