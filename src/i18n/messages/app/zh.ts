...
const app = defineMessages({
  ...
  onboarding: {
    ...
    complete: {
      title: '教程完成',
      body: '您已了解 AEGIS X 的核心功能。现在就可以开始探索，随时可从顶部「新手教程」重新回顾。',
      cta: '开始使用',
    },
    steps: [
      {
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: '连接成功后，您的提案投票记录将显示在此处',
    ...
    burn: {
      ...
      faq: {
        items: [
          ...
          {
            q: '销毁的 AGX 去了哪里？',
            a: '销毁的 AGX 50%转入黑洞地址永久锁定，直接减少流通量、增强通缩，是协议价值回流机制的一部分。50% 注入生态代币 X 底池，强化 X 流动性深度与底池稳定性，构建“收益 → 销毁 → 流动性增强”的价值正循环。',
          },
          {
            q: '贡献点数可以转让或退回吗？',
  ...
  rewards: {
    ...
    cards: {
      ...
      grant: {
        title: '发展津贴',
        body: '生态发展专项津贴',
        aside: '发展津贴以 AGX 发放，无需审批，通过 MarketFund 签名领取，直达钱包。',
      },
      genesis: {
        title: '创世共建奖励',
    ...
    cobuild: {
      ...
      tierLifetime: '终身成就奖',
      tierNoLevel: '暂无级别',
      tierNoLevelHint: '达成 A1 条件后开始获得共建奖',
      tierProgressReach: '达成 {level} 条件进度',
      reqDualLines: '双线达成 {level}',
      reqDualLinesHint: '路径一：任意两条线达到 {level}',
      reqDualLinesValue: '{count} 条',
      reqDualLinesTarget: '2 条',
      reqOtherLine: '其他线业绩',
      reqOtherLineHint: '路径二：单线达成 {level}，且其他线业绩达标',
      recordsTitle: '奖励记录',
    ...
    grant: {
      claimIntoWallet: '直接到账钱包',
      claimHint:
        '发展津贴以 AGX 形式发放，无需审批，可随时领取至钱包；不消耗贡献点数，也不经过释放池与涡轮。',
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: '发展津贴以什么形式发放？',
            a: '发展津贴以 AGX 形式发放。津贴累积后会直接进入您的账户，无需审批，可随时领取至钱包。',
          },
          {
            q: '领取津贴需要审批吗？',
            a: '不需要。津贴发放到账后即为可领取状态，点击领取按钮即可直接到账钱包，无需联系客服申请解锁。',
          },
          {
            q: '领取津贴需要消耗贡献点数吗？',
            a: '不需要。发展津贴与其他奖励不同：领取时不消耗贡献点数，也不经过释放池与涡轮，AGX 将直接进入您的钱包。',
          },
          {
            q: '发展津贴可以用来做什么？',
            a: '津贴专款专用于市场开发：如举办线下沙龙与路演、社区运营与推广物料、渠道拓展等。请围绕生态发展的实际需要使用，并保留相关记录以便后续核查。',
          },
          {
            q: '津贴数量是如何计算的？',
            a: '津贴按团队质押仓位的变动与您共建等级对应的津贴比例计发：团队新增质押时按比例累积津贴，团队赎回时对应比例的津贴将从累积额中扣减，明细可在「津贴记录」的发放页查看。',
          },
          {
            q: '为什么我的津贴数量减少了？',
            a: '当团队成员赎回仓位时，对应比例的津贴会从累积额中扣减，在发放记录中显示为「赎回」类型的负数，这是正常的核算机制。',
          },
        ],
      },
    },
  ...
  proposal: {
    title: '提案',
    intro: '参与协议提案与投票。',
    disconnectedIntro: '连接钱包后即可锁定 AGX 参与投票。',
    backToList: '返回提案',
    voted: '已投票',
    for: '赞成',
    against: '反对',
    amountAria: '本次投票锁定的 AGX',
    lockToVote: '锁定 AGX 投票',
    available: '可用 {amount}',
    votePowerHint:
      '投票权按锁定的 AGX 数量 1:1 计算，同一提案可多次投票，投票权累加；投票期结束后可直接解锁。提案奖励跟随 Rebase 以 AGX 发放，可直接领取到钱包，不消耗贡献点数、不经过涡轮。',
    voteSuccess: '投票已提交',
    withdrawSuccess: '取回已提交',
    voteDeadline: '投票截止 {time}',
    voteOpens: '投票开启 {time}',
    voteEnded: '投票结束 {time}',
    voteMeta: '{time} · 参与投票 {amount}',
    votedStanceNote: '本提案已投{stance} {amount}，投票期结束后可解锁',
    votedLockedNote: '你已投票。投票期结束后可解锁',
    state: {
      pending: '即将开始',
      active: '进行中',
      succeeded: '已通过',
    ...
    closed: {
      pending: '提案尚未开启投票，开启后即可锁定 AGX 参与',
    ...
    blocked: {
      bindCta: '去绑定推荐人',
      zeroAmount: '请输入有效数量',
      belowMin: '单次投票至少 1 AGX',
      notBound: '投票前请先绑定推荐人。',
      notActive: '该提案当前不可投票。',
      supportMismatch: '同一提案只能向已投立场加票。',
      votesLimited: '本笔投票会超过该提案票数上限。',
      insufficientBalance: 'AGX 余额不足',
      insufficientAllowance: '投票前请先授权 AGX。',
      unavailable: '投票暂时不可用。',
      notWithdrawable: '尚未进入领取窗口。',
      expired: '10 天领取窗口已结束。',
      nothingToWithdraw: '没有可取回的仓位。',
    },
    statsTitle: '数据',
    statTotal: '提案总数',
    statTotalNote: '进行中 {active} 项 · 即将开始 {pending} 项',
    statLocked: '投票中锁定',
    statLockedNote: '可用于投票 {amount}',
    statParticipation: '平均参与率',
    statParticipationNote: '近 10 项提案',
    votesTitle: '我的投票记录',
    listEmpty: '官方发布提案后，将显示在此处。',
    votesEmpty: '参与投票后，记录将显示在此处。',
    rewardsTitle: '提案奖励记录',
    rewardsEmpty: '结算完成后，提案奖励将显示在此处。',
    voteColumns: ['时间', '提案', '选项', '投票权', '提案状态', '锁定状态'],
    rewardColumns: ['时间', '提案', '投票权', '提案奖励', '状态'],
    mechanismTitle: '提案机制',
    mechanism: {
      items: [
        {
          title: '锁定投票',
          body: '投票时锁定 AGX，投票权按锁定数量 1:1 计算。锁定的 AGX 在该提案投票期结束后即可直接解锁，无冷却期。',
        },
        {
          title: '提案奖励',
          body: '提案结算时，提案奖励以 AGX 计发，跟随 Rebase 收益发放，可直接领取到钱包，无需消耗贡献点数、不经过涡轮。无论投票结果如何，参与投票即可获得。',
        },
        {
          title: '通过与执行',
          body: '投票期结束时，赞成票的投票权多于反对票即为通过；通过的提案进入执行中，由多签合约在 48 小时内完成上链执行。',
        },
      ],
    },
    eligibility: {
      title: '提案发起资格',
      body: '当前阶段提案由官方团队统一发起，社区参与投票决定是否通过。提案在发布前会同步公告说明背景与影响范围，社区成员可通过官方社群提交提案建议，经评估后由官方整理为正式提案提交投票。协议逐步去中心化后，社区发起提案的权限将通过提案投票开放。',
    },
    faq: {
      title: 'FAQs',
      items: [
        {
          q: '我的投票权是如何计算的？',
          a: '投票权按您在该提案上锁定的 AGX 数量 1:1 计算，锁定 100 AGX 即拥有 100 票投票权。锁定数量由您在投票时自行决定，可少于钱包余额。',
        },
        {
          q: '投票会锁定我的 AGX 吗？锁多久？',
          a: '会。参与投票需锁定 AGX，锁定期至该提案投票期结束为止。投票期结束后锁定的 AGX 自动解锁，无额外冷却期，解锁后可自由使用。',
        },
        {
          q: '投票能获得什么奖励？',
          a: '提案奖励以 AGX 计发，按您在该提案的投票权跟随 Rebase 收益发放。无论提案最终通过或否决、您投的是赞成还是反对，参与投票即可获得。',
        },
        {
          q: '提案奖励如何领取？',
          a: '提案投票期结束、结果结算完成后，该笔奖励在「投票记录」中变为可领取状态，点击「领取」即直接到账钱包——不消耗贡献点数，也不经过涡轮。提案进行中时显示为进行中。',
        },
        {
          q: '谁可以发起提案？',
          a: '当前阶段提案由官方团队统一发起，社区成员参与投票。您可以通过官方社群提交提案建议，经评估后由官方整理为正式提案提交社区投票。',
        },
        {
          q: '提案如何才能通过？',
          a: '投票期结束时，赞成票的投票权多于反对票，提案即为通过，随后进入执行中状态。',
        },
        {
          q: '每个提案可以投几次票？',
          a: '同一提案可在投票期内多次投票，每次投票需追加锁定 AGX，投票权按累计锁定数量计算。但投票方向一经确定即不可更改：首次投出赞成后，后续追加的投票同样计入赞成，不能再投反对，反之亦然。',
        },
      ],
    },
    lock: {
  ...
  assets: {
    ...
    blocked: {
      ...
      insufficientContribution: '贡献点数不足，请先兑换贡献点',
    ...
    claim: {
      ...
      taxRate: '税率 {rate}%',
      contribNeed: '本次领取需扣除贡献点数 {amount}',
      contribShort: '贡献点数不足，请先前往销毁兑换贡献点',
      goBurn: '前往销毁兑换',
      ctaMixed: '复投 & 领取',
      ctaRelease: '领取',
      ctaRestake: '复投',
    ...
    hub: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: '为什么我无法领取收益？',
            a: '领取收益需要消耗贡献点数。如果您的账户没有足够的贡献点数，领取操作将无法进行——请先购买 AGX 并进行销毁以获得贡献点数，再返回资产页领取收益。贡献点数机制确保每一份收益的提取都伴随对协议通缩的贡献。',
          },
          {
            q: '如何获得贡献点数？',
            a: '购买 AGX 并进行销毁即可获得贡献点数。领取收益时按 1:1 消耗贡献点数（领取 1 gAGX 消耗 1 点贡献点数），建议根据待领取的收益数量提前准备足够的贡献点数。',
          },
          {
            q: '领取收益时为什么要选择释放周期？',
  ...
  staking: {
    ...
    blocked: {
      ...
      insufficientQuotaWithAmount:
        '超出可质押额度了：当前最多还能质押 {quota}。请把数量改小后再试。',
      insufficientQuotaPersonalWithAmount:
        '超出你自己的可质押额度了：你的个人累计上限还剩 {quota}，请把数量改小后再试。',
      insufficientQuotaPersonalDailyWithAmount:
        '超出你今天的可质押额度了：你今日个人额度还剩 {quota}，请把数量改小，或等额度刷新后再试。',
      insufficientQuotaPoolWithAmount:
        '链上质押池额度不够了：池子当前还剩 {quota}，请把数量改小，或稍后再试。',
      insufficientXmineQuotaWithAmount:
        '超出你的挖矿额度了：挖矿额度由你的锁定本金决定，当前最多还能质押 {quota}。请把数量改小，或先增加锁定仓位后再试。',
    ...
    stake: {
      ...
      periodAria: '选择质押周期',
      amountAria: '质押数量',
      amountBalance: '数量（钱包余额 {balance}）',
      quotaInline: '质押额度：{quota}',
      submit: '质押',
      bindCta: '去绑定推荐',
      success: '质押成功',
      periods: {
  ...
  release: {
    ...
    faq: {
      ...
      hub: [
        {
          q: '为什么收益不能直接到钱包？',
          a: '释放是收益从产生到可自由支配的必经环节。收益先按您选择的周期进入释放池线性释放，再经涡轮完成解锁后到账钱包。这一节奏把集中抛压转化为持续的买入需求，是保护 AGX 价格与协议长期运行的核心设计。',
        },
        {
          q: '释放池和缓冲池有什么区别？',
          a: '释放池承接的是您从质押、债券、挖矿及各类奖励中主动领取的收益，按所选周期线性释放，领取后进入涡轮；缓冲池承接的是无需选择周期的特定到账资金，释放完成后可直接提取至钱包。两者互不影响，可分别查看和领取。',
        },
        {
          q: '完整的释放路径是怎样的？',
          a: '领取收益 → 按 1:1 消耗贡献点数 → 进入释放池（按周期一次性扣税）→ 线性释放 → 领取进入涡轮 → 以 USD1 买入等量 AGX 解锁 → 冷却结束后提取至钱包。缓冲池路径更短：释放完成后即可直接提取。',
        },
        {
          q: '领取收益为什么要消耗贡献点数？',
          a: '领取时按领取数量 1:1 消耗贡献点数，贡献点数通过销毁 AGX 获得，其中 50% 直接销毁、50% 注入 X 底池。这让每一次收益兑现都同步为协议贡献通缩与流动性。贡献点数不足时可前往销毁页面获取。',
        },
        {
          q: '税率和周期该怎么权衡？',
          a: '周期越短税率越高（5 天 20%、20 天 10%、40 天 5%、60 天 1%），税在进入释放池时一次性扣除。急需到账选短周期，追求最大留存选长周期；也可将收益分批以不同周期进入释放池，兼顾到账速度与成本。',
        },
      ],
      queue: [
        {
