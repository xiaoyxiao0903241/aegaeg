...
const app = defineMessages({
    ...
    genesis: {
      ...
      xTokenAirdropHint: 'एयरड्रॉप पुरस्कार के लिए प्रति खाते प्रति सीज़न ≥ {threshold} का संचयी सह-निर्माण भागीदारी आवश्यक है।',
    ...
    rewards: {
      ...
      heroBodyForRank: 'टीम सदस्यता राशि पर {bonus} पुरस्कार, लॉन्च के बाद 30 दिन {postLaunch} builder उपाधि।',
      ...
      teamQualifiedPartitionsLabel: '{rank} लाइन',
    ...
    community: {
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: 'संगठन विकास कोष की पात्रता कैसे प्राप्त करें?',
            a: 'जब संगठन की संचयी सह-निर्माण प्रदर्शन 1,000,000 USD तक पहुँचती है, तो आपको 5% संगठन विकास कोष समर्थन मिलता है।',
          },
        ],
      },
    },
