...
const app = defineMessages({
    ...
    genesis: {
      ...
      xTokenAirdropHint: 'Tek hesapla toplam ortak inşa tutarı ≥ {threshold} olduğunda airdrop ödülü kazanılır',
      ...
      totalContributed: 'Toplam ortak inşa',
    ...
    rewards: {
      ...
      teamQualifiedPartitionsLabel: '{rank} kolu',
