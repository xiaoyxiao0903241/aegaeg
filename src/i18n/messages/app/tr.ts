...
const app = defineMessages({
  ...
  nav: {
    ...
    proposalTooltip: 'Protokol tekliflerine ve oylamalara katılın.',
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: 'Bağlandıktan sonra teklif oylarınız burada görünür.',
