...
const app = defineMessages({
    ...
    rewards: {
        ...
        superCommunityBenefitBody: 'Süper Topluluklar özel gelişim fonu ve yönetişim hakları alır.',
        ...
        communityFundTooltip: 'Süper topluluklar, sistem gelişim fonunun %5\'ini alır; sistem inşası, günlük operasyonlar, sistem toplantıları ve sistem eğitmenleri dahil olmak üzere sistem öz-işletimine ayrılır.',
