...
const app = defineMessages({
  ...
  errors: {
    ...
    chain: {
      ...
      reverts: {
        ...
        turbineNoSilenceBalance: 'Tidak ada saldo cooldown matang yang dapat ditarik.',
        invalidAmount: 'Jumlah tidak valid. Periksa lalu coba lagi.',
        zeroAddress: 'Alamat tidak valid. Coba lagi nanti.',
        notAuthorized: 'Akun ini tidak berwenang untuk tindakan ini.',
        invalidLimits: 'Konfigurasi batas tidak valid. Coba lagi nanti.',
        nothingToClaim:
          'Tidak ada yang dapat diklaim atau indeks tidak valid. Muat ulang lalu coba lagi.',
        warmupOrLockActive: 'Masih dalam periode warmup atau kunci. Tunggu hingga selesai.',
        walletTokenInsufficient: 'Saldo token di dompet tidak mencukupi.',
        walletAgxInsufficient: 'Saldo AGX di dompet tidak mencukupi.',
        walletUsd1Insufficient: 'Saldo USD1 di dompet tidak mencukupi.',
        walletGagxInsufficient: 'Saldo gAGX di dompet tidak mencukupi.',
        contractPayableInsufficient:
          'Saldo kontrak yang dapat dibayar tidak mencukupi. Coba lagi nanti.',
        extractableInsufficient:
          'Saldo yang dapat ditarik tidak mencukupi. Muat ulang lalu coba lagi.',
        insufficientAllowance: 'Allowance tidak mencukupi. Setujui terlebih dahulu.',
      },
    },
  ...
  nav: {
    ...
    proposalTooltip: 'Ikut proposal dan pemungutan suara protokol.',
  ...
  dapp: {
    connect: {
      ...
      recordsBodyProposal: 'Setelah terhubung, suara proposal Anda akan tampil di sini.',
  ...
  exchange: {
    ...
    slippagePanel: {
      title: 'Slippage',
      hint: 'Toleransi slippage adalah pergerakan harga yang Anda terima antara pengajuan dan eksekusi on-chain. Jika slippage aktual melebihi pengaturan, trade dibatalkan. Transaksi yang dibatalkan tetap bisa memakai gas.',
      modeAuto: 'Default',
      modeCustom: 'Kustom',
      max: 'Slippage maks.',
      customAria: 'Slippage kustom',
    },
    route: 'Rute tukar',
    provider: 'Penyedia',
  ...
  rewards: {
    ...
    restakeSuccess: 'Restake berhasil',
    claimErrors: {
    ...
    hub: {
      ...
      mechanismFooter:
        'Sembarang dua jalur yang mencapai tier yang dibutuhkan membuka promosi. A6–A9 juga bisa naik lewat satu jalur: satu jalur mencapai tier, total volume jalur lain memenuhi ambang.',
      mechanismToggleAria: 'Ganti syarat promosi',
      aboutSlides: {
        lucky: {
      ...
      tierTable: {
        ...
        rows: [
          ...
          },
          {
            ...
            teamAlt: 'Satu jalur mencapai A5, volume jalur lain ≥ $1,000,000',
            rate: '68%',
          },
          {
            level: 'A7',
            ...
            teamAlt: 'Satu jalur mencapai A6, volume jalur lain ≥ $2,000,000',
            rate: '78%',
          },
          {
            level: 'A8',
            ...
            teamAlt: 'Satu jalur mencapai A7, volume jalur lain ≥ $4,000,000',
            rate: '88%',
          },
          {
            level: 'A9',
            ...
            teamAlt: 'Satu jalur mencapai A8, volume jalur lain ≥ $8,000,000',
            rate: '98%',
          },
          {
            level: 'A10',
  ...
  community: {
    ...
    myInvites: 'Referral langsung saya ({count})',
  ...
  assets: {
    ...
    claim: {
      ...
      taxRate: 'pajak {rate}%',
      contribNeed: 'Klaim ini memotong poin kontribusi {amount}',
      contribShort: 'Poin kontribusi tidak cukup — bakar AGX untuk poin dulu',
      goBurn: 'Pergi ke Bakar',
      ctaMixed: 'Restake & Klaim',
      ctaRelease: 'Klaim',
      ctaRestake: 'Investasikan ulang',
      success: 'Klaim dikirim',
      restakeSuccess: 'Restake dikirim',
    ...
    claimOutput: {
      ...
      rewardLabel: 'Hasil',
      boostLabel: 'Bonus',
      claimReward: 'Klaim hasil',
      claimBoost: 'Klaim bonus',
      contribDeduct: 'Memotong poin kontribusi {amount}',
    },
    redeem: {
      releasedLabel: 'Dirilis',
      title: 'Tebus stake',
      body: 'Setelah tebus, aset masuk buffer untuk rilis linear selama {days} hari. Aset di buffer tidak menghasilkan yield',
      confirmCta: 'Tebus',
