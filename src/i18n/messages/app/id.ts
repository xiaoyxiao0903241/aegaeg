...
const app = defineMessages({
  ...
  genesis: {
    ...
    connectBrandLine: 'Jaga jaringan nilai masa depan',
    contributionsConnectTitle: 'Hubungkan dompet untuk melihat catatan Anda',
    contributionsConnectBody: 'Setelah terhubung, riwayat co-build Anda akan ditampilkan di sini.',
  ...
  rewards: {
    ...
    shareholderNoRankBody:
      'Menjadi pemegang saham Genesis memberi hadiah 1%-10% dari volume co-build tim dan naik 1 level dalam 30 hari setelah peluncuran AEGIS X.',
    ...
    historyConnectBody: 'Setelah terhubung, riwayat hadiah Anda akan ditampilkan di sini.',
