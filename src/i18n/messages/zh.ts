...
const zh = defineMessages({
  ...
  rewards: {
    ...
    faqReferral: '推荐奖励如何计算？',
    faqReferralBody: '当被推荐人在 Genesis 期间完成认购后，推荐奖励将自动发放至钱包，比例与股东等级相关。',
    faqTeamClaim: '团队奖励如何领取？',
    faqTeamClaimBody: '团队奖励按结算周期累计，左侧「领取至钱包」在可领取余额出现时即可操作。',
    faqRank: '股东等级如何判定？',
    faqRankBody: '等级依据个人 Genesis 认购额与团队业绩综合评定，等级越高团队奖励比例越大。',
