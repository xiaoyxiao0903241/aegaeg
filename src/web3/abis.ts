...
export const AGX_CONTRIBUTION_SWAP_METHODS = {
  ...
  /** Mixed 消耗除数：所需贡献 = rewardAmount / contributionDivisor；领取文案不读此值 */
...
export const AEGIS_PROPOSAL_METHODS = {
  ...
  getVoteRewards:
    'function getVoteRewards(uint256 proposalId, address voter) view returns (uint256 principal, uint256 blockReward, uint256 extraInterest)',
  getVoteReceipt:
