...
> **文档链**
> 1. 本 skill（门禁）
> 2. [`runbook.md`](../../docs/foundation/runbook.md) — 怎么改
> 3. [`api.md`](../../docs/foundation/api.md) — 改什么
> 4. [`verification.md`](../../docs/foundation/verification.md) — 怎么验
