...
test('fetchLiveGenesisPostApproveGate re-reads bind/pause (not render snapshot)', async () => {
  const { fetchLiveGenesisPostApproveGate } = await loadModule(
  ...
  const ok = await fetchLiveGenesisPostApproveGate({
  ...
  const unboundAfterApprove = await fetchLiveGenesisPostApproveGate({
    address: '0x1111111111111111111111111111111111111111',
  ...
  const pausedAfterApprove = await fetchLiveGenesisPostApproveGate({
    address: '0x1111111111111111111111111111111111111111',
  ...
  const readFailed = await fetchLiveGenesisPostApproveGate({
    address: '0x1111111111111111111111111111111111111111',
    fetchIsBound: async () => {
  ...
  const missingAddress = await fetchLiveGenesisPostApproveGate({
    address: undefined,
    fetchIsBound: async () => true,
    fetchPaused: async () => false,
  })
