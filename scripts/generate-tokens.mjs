...
:root {
  ...
  /* 面积图绘图区；16px 根上 170 */
  --chart-plot-height: 10.625rem;
  /* 点阵底纹；16px 根上 10 / 0.9 */
  --chart-plot-dot: radial-gradient(circle, rgba(0, 0, 0, 0.14) calc(0.9rem / 16), transparent 0.0625rem);
  --chart-plot-dot-size: 0.625rem;
  /* 测算日标记 / 十字线圆点；16px 根上 9 / 1.5 */
  --chart-mark-size: 0.5625rem;
  --chart-mark-border: calc(1.5rem / 16);
  /* 参考虚线：粗细 1 / 段长 4 / 间距 2（16px 根） */
  --chart-guide-stroke: 0.0625rem;
  --chart-guide-dash: 0.25rem;
