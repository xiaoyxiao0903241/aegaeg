...
- **`UBIQUITOUS_LANGUAGE.md`** — this repo's business vocabulary SSOT (alongside any future `CONTEXT.md`).
...
├── UBIQUITOUS_LANGUAGE.md     ← present; business terms
├── docs/adr/                  ← created lazily when needed
└── src/
```
